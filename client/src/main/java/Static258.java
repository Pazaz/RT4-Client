...
public final class Static258 {
	...
	public static void method4418(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) Component arg2) {
		if (arg2.anInt530 == 1) {
			Static98.method1966(-1, 0L, Static186.EMPTY_FILE, 0, (short) 8, arg2.aClass100_89, arg2.anInt507);
		}
		@Pc(47) JagString local47;
		if (arg2.anInt530 == 2 && !Static241.aBoolean302) {
			local47 = Static97.method1963(arg2);
			if (local47 != null) {
				Static98.method1966(-1, 0L, Static34.concatenate(new JagString[] { Static42.aClass100_332, arg2.aClass100_85 }), -1, (short) 32, local47, arg2.anInt507);
			}
		}
		if (arg2.anInt530 == 3) {
			Static98.method1966(-1, 0L, Static186.EMPTY_FILE, 0, (short) 28, LocalizedText.CLOSE, arg2.anInt507);
		}
		if (arg2.anInt530 == 4) {
			Static98.method1966(-1, 0L, Static186.EMPTY_FILE, 0, (short) 59, arg2.aClass100_89, arg2.anInt507);
		}
		if (arg2.anInt530 == 5) {
			Static98.method1966(-1, 0L, Static186.EMPTY_FILE, 0, (short) 51, arg2.aClass100_89, arg2.anInt507);
		}
		if (arg2.anInt530 == 6 && Static39.aClass13_10 == null) {
			Static98.method1966(-1, 0L, Static186.EMPTY_FILE, -1, (short) 41, arg2.aClass100_89, arg2.anInt507);
		}
		@Pc(173) int local173;
		@Pc(171) int local171;
		if (arg2.anInt452 == 2) {
						...
						if (arg2.objTypes[local171] > 0) {
							...
							if (Static260.anInt5014 == 1 && local267.method510()) {
								if (Static224.anInt5062 != arg2.anInt507 || Static185.anInt4370 != local171) {
									Static98.method1966(-1, (long) local276.anInt2354, Static34.concatenate(new JagString[] { Static34.aClass100_203, Static223.aClass100_947, local276.aClass100_495 }), local171, (short) 40, LocalizedText.USE, arg2.anInt507);
								}
								...
								if ((Static274.anInt4999 & 0x10) != 0 && (local596 == null || local276.method1829(local596.anInt2667, Static121.anInt3039) != local596.anInt2667)) {
									Static98.method1966(Static246.anInt5393, (long) local276.anInt2354, Static34.concatenate(new JagString[] { Static78.aClass100_466, Static223.aClass100_947, local276.aClass100_495 }), local171, (short) 3, Static102.aClass100_545, arg2.anInt507);
								}
							} else {
								...
								if (local267.method510()) {
									for (local309 = 4; local309 >= 3; local309--) {
										if (local296 != null && local296[local309] != null) {
											...
											Static98.method1966(-1, (long) local276.anInt2354, Static34.concatenate(new JagString[] { Static8.aClass100_32, local276.aClass100_495 }), local171, local334, local296[local309], arg2.anInt507);
										}
									}
								}
								if (local267.method507()) {
									Static98.method1966(Static169.anInt4075, (long) local276.anInt2354, Static34.concatenate(new JagString[] { Static8.aClass100_32, local276.aClass100_495 }), local171, (short) 22, LocalizedText.USE, arg2.anInt507);
								}
								...
								Static98.method1966(Static225.anInt5073, (long) local276.anInt2354, Static34.concatenate(new JagString[] { Static8.aClass100_32, local276.aClass100_495 }), local171, (short) 1006, LocalizedText.EXAMINE, arg2.anInt507);
							}
						}
					}
					local171++;
		...
		if (!Static241.aBoolean302) {
			...
			if (Static36.method940(arg2).method506()) {
				Static98.method1966(-1, 0L, Static186.EMPTY_FILE, arg2.componentId, (short) 41, LocalizedText.CONTINUE, arg2.anInt507);
			}
		} else if (Static36.method940(arg2).method508() && (Static274.anInt4999 & 0x20) != 0) {
			Static98.method1966(Static246.anInt5393, 0L, Static34.concatenate(new JagString[] { Static78.aClass100_466, Static201.aClass100_408, arg2.aClass100_88 }), arg2.componentId, (short) 12, Static102.aClass100_545, arg2.anInt507);
		}
	}
