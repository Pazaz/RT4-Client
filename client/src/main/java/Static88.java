		...
		try {
			...
			for (cycles = 1; cycles < local4.length; cycles++) {
				if (local4[cycles] instanceof Integer) {
					...
					if (id == -2147483647) {
						id = request.anInt3102;
					}
					if (id == -2147483646) {
						id = request.anInt3097;
					}
					if (id == -2147483645) {
						id = request.source == null ? -1 : request.source.anInt507;
					}
					if (id == -2147483644) {
						id = request.anInt3101;
					}
					if (id == -2147483643) {
						id = request.source == null ? -1 : request.source.componentId;
					}
					if (id == -2147483642) {
						id = request.aClass13_16 == null ? -1 : request.aClass13_16.anInt507;
					}
					if (id == -2147483641) {
						id = request.aClass13_16 == null ? -1 : request.aClass13_16.componentId;
					}
					if (id == -2147483640) {
						id = request.anInt3100;
					}
					if (id == -2147483639) {
						id = request.anInt3099;
					}
					Static215.intLocals[local50++] = id;
				} else if (local4[cycles] instanceof JagString) {
					local194 = (JagString) local4[cycles];
					if (local194.method3108(Static15.aClass100_83)) {
						local194 = request.aClass100_598;
					}
					Static180.stringLocals[local56++] = local194;
				}
			}
			cycles = 0;
			nextOp: while (true) {
				...
				if (opcode < 100) {
					...
					if (opcode == 37) {
						id = intOperands[pc];
						ssp -= id;
						local609 = Static118.method2355(ssp, id, Static3.stringStack);
						Static3.stringStack[ssp++] = local609;
						continue;
					}
					if (opcode == 38) {
						isp--;
					...
					if (opcode == 45) {
						...
						if (local809 >= 0 && local809 < Static55.anIntArray140[id]) {
							Static254.intStack[isp++] = Static179.anIntArrayArray33[id][local809];
							continue;
						}
						throw new RuntimeException();
					}
					if (opcode == 46) {
						...
						local809 = Static254.intStack[isp];
						if (local809 >= 0 && local809 < Static55.anIntArray140[id]) {
							Static179.anIntArrayArray33[id][local809] = Static254.intStack[isp + 1];
							continue;
						}
						throw new RuntimeException();
					}
					if (opcode == 47) {
						local194 = Static226.varcstrs[intOperands[pc]];
						if (local194 == null) {
							local194 = Static254.aClass100_1061;
						}
						Static3.stringStack[ssp++] = local194;
						continue;
					}
					if (opcode == 48) {
						id = intOperands[pc];
					...
					if (opcode == 51) {
						...
						isp--;
						@Pc(1002) IntNode local1002 = (IntNode) local992.method3863((long) Static254.intStack[isp]);
						if (local1002 != null) {
				...
				if (opcode < 300) {
					...
					if (opcode == 102) {
						isp--;
						local1182 = Static5.getComponent(Static254.intStack[isp]);
					...
					if (opcode < 500) {
						...
						if ((opcode < 1000 || opcode >= 1100) && (opcode < 2000 || opcode >= 2100)) {
							...
							if (opcode >= 1100 && opcode < 1200 || !(opcode < 2100 || opcode >= 2200)) {
								...
								if (opcode == 1100) {
									isp -= 2;
									local1182.anInt489 = Static254.intStack[isp];
									...
									local1182.scrollY = Static254.intStack[isp + 1];
								...
								if (opcode == 1101) {
									isp--;
									local1182.anInt474 = Static254.intStack[isp];
									Static43.method1143(local1182);
									if (local1182.componentId == -1) {
								...
								if (opcode == 1102) {
									isp--;
									local1182.aBoolean30 = Static254.intStack[isp] == 1;
									Static43.method1143(local1182);
									continue;
								}
								if (opcode == 1103) {
									isp--;
									local1182.anInt476 = Static254.intStack[isp];
									Static43.method1143(local1182);
									continue;
								}
								if (opcode == 1104) {
									isp--;
									local1182.anInt490 = Static254.intStack[isp];
									Static43.method1143(local1182);
									continue;
								}
								if (opcode == 1105) {
									isp--;
									local1182.anInt477 = Static254.intStack[isp];
									Static43.method1143(local1182);
									continue;
								}
								if (opcode == 1106) {
									isp--;
									local1182.anInt521 = Static254.intStack[isp];
									Static43.method1143(local1182);
									continue;
								}
								if (opcode == 1107) {
									isp--;
									local1182.aBoolean23 = Static254.intStack[isp] == 1;
									Static43.method1143(local1182);
									continue;
								}
								if (opcode == 1108) {
									...
									isp--;
									local1182.modelId = Static254.intStack[isp];
									Static43.method1143(local1182);
									if (local1182.componentId == -1) {
								...
								if (opcode == 1109) {
									isp -= 6;
									local1182.modelXOffset = Static254.intStack[isp];
									local1182.modelZOffset = Static254.intStack[isp + 1];
									local1182.modelXAngle = Static254.intStack[isp + 2];
									local1182.modelYAngle = Static254.intStack[isp + 3];
									local1182.modelYOffset = Static254.intStack[isp + 4];
									local1182.modelZoom = Static254.intStack[isp + 5];
									Static43.method1143(local1182);
									if (local1182.componentId == -1) {
								...
								if (opcode == 1111) {
									isp--;
									local1182.aBoolean22 = Static254.intStack[isp] == 1;
									Static43.method1143(local1182);
									continue;
								}
								if (opcode == 1112) {
								...
								if (opcode == 1113) {
									isp--;
									local1182.anInt502 = Static254.intStack[isp];
									Static43.method1143(local1182);
									continue;
								}
								if (opcode == 1114) {
									isp -= 3;
									local1182.anInt460 = Static254.intStack[isp];
									local1182.anInt478 = Static254.intStack[isp + 1];
									local1182.anInt467 = Static254.intStack[isp + 2];
									Static43.method1143(local1182);
									continue;
								}
								if (opcode == 1115) {
									isp--;
									local1182.aBoolean28 = Static254.intStack[isp] == 1;
									Static43.method1143(local1182);
									continue;
								}
								if (opcode == 1116) {
									isp--;
									local1182.anInt514 = Static254.intStack[isp];
									Static43.method1143(local1182);
									continue;
								}
								if (opcode == 1117) {
									isp--;
									local1182.anInt513 = Static254.intStack[isp];
									Static43.method1143(local1182);
									continue;
								}
								if (opcode == 1118) {
									isp--;
									local1182.aBoolean21 = Static254.intStack[isp] == 1;
									Static43.method1143(local1182);
									continue;
								}
								if (opcode == 1119) {
									isp--;
									local1182.aBoolean26 = Static254.intStack[isp] == 1;
									Static43.method1143(local1182);
									continue;
								}
								if (opcode == 1120) {
									isp -= 2;
									local1182.anInt486 = Static254.intStack[isp];
									local1182.anInt491 = Static254.intStack[isp + 1];
									Static43.method1143(local1182);
								...
								if (opcode == 1121) {
									isp -= 2;
									local1182.aShort11 = (short) Static254.intStack[isp];
									local1182.aShort10 = (short) Static254.intStack[isp + 1];
									Static43.method1143(local1182);
									continue;
								}
								if (opcode == 1122) {
									isp--;
									local1182.aBoolean18 = Static254.intStack[isp] == 1;
									Static43.method1143(local1182);
									continue;
								}
								if (opcode == 1123) {
									isp--;
									local1182.modelZoom = Static254.intStack[isp];
									Static43.method1143(local1182);
									if (local1182.componentId == -1) {
										Static153.method2910(local1182.anInt507);
									}
								...
								if (opcode == 1300) {
									...
									if (local803 >= 0 && local803 <= 9) {
										ssp--;
										local1182.method480(Static3.stringStack[ssp], local803);
										continue;
									}
									ssp--;
									continue;
								...
								if (opcode == 1302) {
									isp--;
									local1182.aBoolean27 = Static254.intStack[isp] == 1;
									continue;
								}
								if (opcode == 1303) {
									isp--;
									local1182.anInt472 = Static254.intStack[isp];
									continue;
								}
								if (opcode == 1304) {
									isp--;
									local1182.anInt447 = Static254.intStack[isp];
									continue;
								}
								if (opcode == 1305) {
									ssp--;
									local1182.aClass100_88 = Static3.stringStack[ssp];
									continue;
								}
								if (opcode == 1306) {
									ssp--;
									local1182.aClass100_86 = Static3.stringStack[ssp];
									continue;
								}
								if (opcode == 1307) {
								...
								if (opcode == 1308) {
									isp--;
									local1182.anInt484 = Static254.intStack[isp];
									isp--;
									local1182.anInt499 = Static254.intStack[isp];
									continue;
								}
								if (opcode == 1309) {
									isp--;
								...
								if (opcode >= 1400 && opcode < 1500 || opcode >= 2400 && opcode < 2500) {
									...
									for (local4859 = local13000.length - 1; local4859 >= 1; local4859--) {
										if (local2522.method3149(local4859 - 1) == 115) {
											ssp--;
											local13000[local4859] = Static3.stringStack[ssp];
										} else {
											isp--;
											local13000[local4859] = Integer.valueOf(Static254.intStack[isp]);
										}
									}
									isp--;
									local4859 = Static254.intStack[isp];
									if (local4859 == -1) {
										local13000 = null;
									} else {
								...
								if (opcode < 1600) {
									local1182 = local1020 ? Static274.aClass13_24 : Static227.aClass13_25;
									if (opcode == 1500) {
										Static254.intStack[isp++] = local1182.x;
										continue;
									}
									if (opcode == 1501) {
										Static254.intStack[isp++] = local1182.y;
										continue;
									}
									if (opcode == 1502) {
										Static254.intStack[isp++] = local1182.anInt445;
										continue;
									}
									if (opcode == 1503) {
										Static254.intStack[isp++] = local1182.anInt459;
										continue;
									}
									if (opcode == 1504) {
										Static254.intStack[isp++] = local1182.hidden ? 1 : 0;
										continue;
									}
									if (opcode == 1505) {
										Static254.intStack[isp++] = local1182.layer;
										continue;
									}
								} else if (opcode < 1700) {
									local1182 = local1020 ? Static274.aClass13_24 : Static227.aClass13_25;
									if (opcode == 1600) {
										Static254.intStack[isp++] = local1182.anInt489;
										continue;
									}
									if (opcode == 1601) {
										Static254.intStack[isp++] = local1182.scrollY;
										continue;
									}
									if (opcode == 1602) {
										Static3.stringStack[ssp++] = local1182.aClass100_84;
										continue;
									}
									if (opcode == 1603) {
										Static254.intStack[isp++] = local1182.anInt486;
										continue;
									}
									if (opcode == 1604) {
										Static254.intStack[isp++] = local1182.anInt491;
										continue;
									}
									if (opcode == 1605) {
										Static254.intStack[isp++] = local1182.modelZoom;
										continue;
									}
									if (opcode == 1606) {
										Static254.intStack[isp++] = local1182.modelXAngle;
										continue;
									}
									if (opcode == 1607) {
										Static254.intStack[isp++] = local1182.modelYOffset;
										continue;
									}
									if (opcode == 1608) {
										Static254.intStack[isp++] = local1182.modelYAngle;
										continue;
									}
									if (opcode == 1609) {
										Static254.intStack[isp++] = local1182.anInt476;
										continue;
									}
									if (opcode == 1610) {
										Static254.intStack[isp++] = local1182.modelXOffset;
										continue;
									}
									if (opcode == 1611) {
										Static254.intStack[isp++] = local1182.modelZOffset;
										continue;
									}
									if (opcode == 1612) {
										Static254.intStack[isp++] = local1182.anInt477;
										continue;
									}
								} else if (opcode < 1800) {
									local1182 = local1020 ? Static274.aClass13_24 : Static227.aClass13_25;
									if (opcode == 1700) {
										Static254.intStack[isp++] = local1182.objId;
										continue;
									}
									if (opcode == 1701) {
										if (local1182.objId == -1) {
											...
											Static254.intStack[isp++] = local1182.objCount;
										}
										continue;
									}
									if (opcode == 1702) {
										Static254.intStack[isp++] = local1182.componentId;
										continue;
									}
								} else if (opcode < 1900) {
									local1182 = local1020 ? Static274.aClass13_24 : Static227.aClass13_25;
									if (opcode == 1800) {
										Static254.intStack[isp++] = Static36.method940(local1182).method512();
										continue;
									}
									if (opcode == 1801) {
										isp--;
										...
										if (local1182.aClass100Array18 != null && local803 < local1182.aClass100Array18.length && local1182.aClass100Array18[local803] != null) {
											Static3.stringStack[ssp++] = local1182.aClass100Array18[local803];
											continue;
										}
										Static3.stringStack[ssp++] = Static72.aClass100_447;
										continue;
									}
									if (opcode == 1802) {
										if (local1182.aClass100_88 == null) {
											...
											Static3.stringStack[ssp++] = local1182.aClass100_88;
										}
										continue;
									}
								} else if (opcode < 2600) {
									...
									if (opcode == 3100) {
										ssp--;
										local609 = Static3.stringStack[ssp];
									...
									if (opcode == 3301) {
										...
										local809 = Static254.intStack[isp];
										local803 = Static254.intStack[isp + 1];
										Static254.intStack[isp++] = Static15.method484(local809, local803);
										continue;
									}
									if (opcode == 3302) {
										isp -= 2;
										local803 = Static254.intStack[isp + 1];
										local809 = Static254.intStack[isp];
										Static254.intStack[isp++] = Static23.method647(local809, local803);
										continue;
									}
									if (opcode == 3303) {
										isp -= 2;
										local803 = Static254.intStack[isp + 1];
										local809 = Static254.intStack[isp];
										Static254.intStack[isp++] = Static278.method4652(local809, local803);
										continue;
									}
									if (opcode == 3304) {
										isp--;
										local809 = Static254.intStack[isp];
										Static254.intStack[isp++] = Static246.method4241(local809).anInt3706;
										continue;
									}
									if (opcode == 3305) {
										isp--;
										local809 = Static254.intStack[isp];
										Static254.intStack[isp++] = Static99.anIntArray240[local809];
										continue;
									}
									if (opcode == 3306) {
										isp--;
										local809 = Static254.intStack[isp];
										Static254.intStack[isp++] = Static141.anIntArray326[local809];
										continue;
									}
									if (opcode == 3307) {
										isp--;
										local809 = Static254.intStack[isp];
										Static254.intStack[isp++] = Static227.anIntArray446[local809];
										continue;
									}
									if (opcode == 3308) {
										...
										Static254.intStack[isp++] = (local809 << 28) - (-(local803 << 14) - local1052);
										continue;
									}
									if (opcode == 3309) {
										isp--;
										local809 = Static254.intStack[isp];
										Static254.intStack[isp++] = local809 >> 14 & 0x3FFF;
										continue;
									}
									if (opcode == 3310) {
										isp--;
										local809 = Static254.intStack[isp];
										Static254.intStack[isp++] = local809 >> 28;
										continue;
									}
									if (opcode == 3311) {
										isp--;
										local809 = Static254.intStack[isp];
										Static254.intStack[isp++] = local809 & 0x3FFF;
										continue;
									}
									if (opcode == 3312) {
									...
									if (opcode == 3313) {
										isp -= 2;
										local809 = Static254.intStack[isp] + 32768;
										local803 = Static254.intStack[isp + 1];
										Static254.intStack[isp++] = Static15.method484(local809, local803);
										continue;
									}
									...
									if (opcode == 3330) {
										isp--;
										local809 = Static254.intStack[isp];
										Static254.intStack[isp++] = Static11.method446(local809);
										continue;
									}
									if (opcode == 3331) {
										isp -= 2;
										local803 = Static254.intStack[isp + 1];
										local809 = Static254.intStack[isp];
										Static254.intStack[isp++] = Static178.method3319(false, local809, local803);
										continue;
									}
									if (opcode == 3332) {
										isp -= 2;
										local809 = Static254.intStack[isp];
										local803 = Static254.intStack[isp + 1];
										Static254.intStack[isp++] = Static178.method3319(true, local809, local803);
										continue;
									}
									if (opcode == 3333) {
									...
									if (opcode == 3335) {
										Static254.intStack[isp++] = Static141.anInt3470;
										continue;
									}
									if (opcode == 3336) {
										isp -= 4;
										...
										local809 += local652;
										Static254.intStack[isp++] = local809;
										continue;
									}
									if (opcode == 3337) {
										Static254.intStack[isp++] = Static204.anInt4760;
										continue;
									}
								} else if (opcode < 3500) {
									...
									if (opcode == 3400) {
										...
										Static3.stringStack[ssp++] = local3422.method3085(local803);
										continue;
									}
									if (opcode == 3408) {
										isp -= 4;
										...
										if (local3469.anInt3957 == local809 && local3469.anInt3950 == local803) {
											if (local803 == 115) {
												Static3.stringStack[ssp++] = local3469.method3085(local652);
											} else {
												Static254.intStack[isp++] = local3469.method3089(local652);
											}
											continue;
										}
									...
									if (opcode == 3409) {
										...
										Static254.intStack[isp++] = local3549.method3090(local1052) ? 1 : 0;
										continue;
									}
									if (opcode == 3410) {
										isp--;
										...
										Static254.intStack[isp++] = local3422.method3086(local2522) ? 1 : 0;
										continue;
									}
									if (opcode == 3411) {
										isp--;
										...
										Static254.intStack[isp++] = local3645.aClass133_16.method3864();
										continue;
									}
								} else if (opcode < 3700) {
									if (opcode == 3600) {
									...
									if (opcode == 3601) {
										...
										if (Static166.anInt4054 == 2 && local809 < Static9.anInt178) {
											Static3.stringStack[ssp++] = Static122.aClass100Array92[local809];
											continue;
										}
										Static3.stringStack[ssp++] = Static72.aClass100_447;
										continue;
									...
									if (opcode == 3602) {
										...
										if (Static166.anInt4054 == 2 && Static9.anInt178 > local809) {
											Static254.intStack[isp++] = Static104.anIntArray255[local809];
											continue;
										}
										Static254.intStack[isp++] = 0;
										continue;
									...
									if (opcode == 3603) {
										...
										local809 = Static254.intStack[isp];
										if (Static166.anInt4054 == 2 && Static9.anInt178 > local809) {
											Static254.intStack[isp++] = Static106.anIntArray258[local809];
											continue;
										}
										Static254.intStack[isp++] = 0;
										continue;
									...
									if (opcode == 3609) {
										...
										Static254.intStack[isp++] = Static98.method1965(local609) ? 1 : 0;
										continue;
									}
									if (opcode == 3610) {
										isp--;
										local809 = Static254.intStack[isp];
										if (Static166.anInt4054 == 2 && Static9.anInt178 > local809) {
											Static3.stringStack[ssp++] = Static214.aClass100Array170[local809];
											continue;
										}
										Static3.stringStack[ssp++] = Static72.aClass100_447;
										continue;
									...
									if (opcode == 3613) {
										...
										if (Static15.aClass100_87 != null && Static214.anInt5577 > local809) {
											Static3.stringStack[ssp++] = Static199.aClass3_Sub22Array1[local809].aClass100_636.method3125();
											continue;
										}
										Static3.stringStack[ssp++] = Static72.aClass100_447;
										continue;
									...
									if (opcode == 3614) {
										...
										if (Static15.aClass100_87 != null && local809 < Static214.anInt5577) {
											Static254.intStack[isp++] = Static199.aClass3_Sub22Array1[local809].anInt3340;
											continue;
										}
										Static254.intStack[isp++] = 0;
										continue;
									...
									if (opcode == 3615) {
										...
										local809 = Static254.intStack[isp];
										if (Static15.aClass100_87 != null && Static214.anInt5577 > local809) {
											Static254.intStack[isp++] = Static199.aClass3_Sub22Array1[local809].aByte9;
											continue;
										}
										Static254.intStack[isp++] = 0;
										continue;
									...
									if (opcode == 3622) {
										...
										if (Static166.anInt4054 != 0 && Static35.anInt1093 > local809) {
											Static3.stringStack[ssp++] = Static79.decode37(Static190.aLongArray6[local809]).method3125();
											continue;
										}
										Static3.stringStack[ssp++] = Static72.aClass100_447;
										continue;
									...
									if (opcode == 3623) {
										...
										Static254.intStack[isp++] = Static238.method4144(local609) ? 1 : 0;
										continue;
									}
									if (opcode == 3624) {
										isp--;
									...
									if (opcode == 3626) {
										...
										local809 = Static254.intStack[isp];
										if (Static15.aClass100_87 != null && Static214.anInt5577 > local809) {
											Static3.stringStack[ssp++] = Static199.aClass3_Sub22Array1[local809].aClass100_635;
											continue;
										}
										Static3.stringStack[ssp++] = Static72.aClass100_447;
										continue;
									...
									if (opcode == 3627) {
										...
										if (Static166.anInt4054 == 2 && local809 >= 0 && local809 < Static9.anInt178) {
											Static254.intStack[isp++] = Static3.aBooleanArray135[local809] ? 1 : 0;
											continue;
										}
										Static254.intStack[isp++] = 0;
										continue;
									...
									if (opcode == 3628) {
										...
										Static254.intStack[isp++] = Static4.method25(local609);
										continue;
									}
									if (opcode == 3629) {
										Static254.intStack[isp++] = Static279.anInt5880;
										continue;
									}
								} else if (opcode < 4000) {
									if (opcode == 3903) {
										isp--;
										local809 = Static254.intStack[isp];
										Static254.intStack[isp++] = Static229.aClass136Array1[local809].method3905();
										continue;
									}
									if (opcode == 3904) {
										isp--;
										local809 = Static254.intStack[isp];
										Static254.intStack[isp++] = Static229.aClass136Array1[local809].anInt5094;
										continue;
									}
									if (opcode == 3905) {
										isp--;
										local809 = Static254.intStack[isp];
										Static254.intStack[isp++] = Static229.aClass136Array1[local809].anInt5099;
										continue;
									}
									if (opcode == 3906) {
										isp--;
										local809 = Static254.intStack[isp];
										Static254.intStack[isp++] = Static229.aClass136Array1[local809].anInt5090;
										continue;
									}
									if (opcode == 3907) {
										isp--;
										local809 = Static254.intStack[isp];
										Static254.intStack[isp++] = Static229.aClass136Array1[local809].anInt5089;
										continue;
									}
									if (opcode == 3908) {
										isp--;
										local809 = Static254.intStack[isp];
										Static254.intStack[isp++] = Static229.aClass136Array1[local809].anInt5092;
										continue;
									}
									if (opcode == 3910) {
										isp--;
									...
									if (opcode == 4000) {
										...
										local809 = Static254.intStack[isp];
										local803 = Static254.intStack[isp + 1];
										Static254.intStack[isp++] = local803 + local809;
										continue;
									}
									if (opcode == 4001) {
										isp -= 2;
										local809 = Static254.intStack[isp];
										local803 = Static254.intStack[isp + 1];
										Static254.intStack[isp++] = local809 - local803;
										continue;
									}
									if (opcode == 4002) {
										isp -= 2;
									...
									if (opcode == 4004) {
										isp--;
										local809 = Static254.intStack[isp];
										Static254.intStack[isp++] = (int) ((double) local809 * Math.random());
										continue;
									}
									if (opcode == 4005) {
										isp--;
										local809 = Static254.intStack[isp];
										Static254.intStack[isp++] = (int) (Math.random() * (double) (local809 + 1));
										continue;
									}
									if (opcode == 4006) {
										isp -= 5;
										...
										local652 = Static254.intStack[isp + 3];
										local1052 = Static254.intStack[isp + 2];
										local4859 = Static254.intStack[isp + 4];
										Static254.intStack[isp++] = (local803 - local809) * (local4859 + -local1052) / (local652 - local1052) + local809;
										continue;
									}
									...
									if (opcode == 4008) {
										...
										local809 = Static254.intStack[isp];
										local803 = Static254.intStack[isp + 1];
										Static254.intStack[isp++] = local809 | 0x1 << local803;
										continue;
									}
									if (opcode == 4009) {
										isp -= 2;
										local809 = Static254.intStack[isp];
										local803 = Static254.intStack[isp + 1];
										Static254.intStack[isp++] = -(0x1 << local803) - 1 & local809;
										continue;
									}
									if (opcode == 4010) {
										isp -= 2;
										local809 = Static254.intStack[isp];
										local803 = Static254.intStack[isp + 1];
										Static254.intStack[isp++] = (local809 & 0x1 << local803) == 0 ? 0 : 1;
										continue;
									}
									if (opcode == 4011) {
										isp -= 2;
									...
									if (opcode == 4012) {
										...
										if (local809 == 0) {
											...
											Static254.intStack[isp++] = (int) Math.pow((double) local809, (double) local803);
										}
										continue;
									}
									if (opcode == 4013) {
										...
										if (local809 == 0) {
											...
											Static254.intStack[isp++] = (int) Math.pow((double) local809, 1.0D / (double) local803);
										}
										continue;
									}
									if (opcode == 4014) {
									...
									if (opcode == 4016) {
										...
										local809 = Static254.intStack[isp];
										local803 = Static254.intStack[isp + 1];
										Static254.intStack[isp++] = local809 < local803 ? local809 : local803;
										continue;
									}
									if (opcode == 4017) {
										isp -= 2;
										local803 = Static254.intStack[isp + 1];
										local809 = Static254.intStack[isp];
										Static254.intStack[isp++] = local803 >= local809 ? local803 : local809;
										continue;
									}
									if (opcode == 4018) {
										isp -= 3;
									...
									if (opcode < 4300) {
										if (opcode == 4200) {
											isp--;
											local809 = Static254.intStack[isp];
											Static3.stringStack[ssp++] = Static71.method1439(local809).aClass100_495;
											continue;
										}
										...
										if (opcode == 4203) {
											isp--;
											local809 = Static254.intStack[isp];
											Static254.intStack[isp++] = Static71.method1439(local809).anInt2325;
											continue;
										}
										if (opcode == 4204) {
											isp--;
											local809 = Static254.intStack[isp];
											Static254.intStack[isp++] = Static71.method1439(local809).anInt2336 == 1 ? 1 : 0;
											continue;
										}
										...
										if (opcode == 4207) {
											isp--;
											local809 = Static254.intStack[isp];
											Static254.intStack[isp++] = Static71.method1439(local809).aBoolean131 ? 1 : 0;
											continue;
										}
										if (opcode == 4208) {
											isp -= 2;
											...
											if (local5294.method2078()) {
												Static3.stringStack[ssp++] = Static71.method1439(local809).method1819(local5294.aClass100_544, local803);
											} else {
												Static254.intStack[isp++] = Static71.method1439(local809).method1829(local5294.anInt2667, local803);
											}
											continue;
										}
										if (opcode == 4210) {
										...
										if (opcode == 4300) {
											...
											local5294 = Static110.method2277(local803);
											if (local5294.method2078()) {
												Static3.stringStack[ssp++] = Static214.method4363(local809).method2938(local803, local5294.aClass100_544);
											} else {
												Static254.intStack[isp++] = Static214.method4363(local809).method2936(local803, local5294.anInt2667);
											}
											continue;
										}
									} else if (opcode >= 4500) {
										if (opcode >= 4600) {
											if (opcode < 5100) {
												...
												if (opcode == 5054) {
													...
													local803 = Static254.intStack[isp + 1];
													local809 = Static254.intStack[isp];
													Static254.intStack[isp++] = Static235.method4045(local809).anIntArray32[local803];
													continue;
												}
												if (opcode == 5055) {
													isp--;
													local809 = Static254.intStack[isp];
													Static3.stringStack[ssp++] = Static230.method3953(local809).method769();
													continue;
												}
												if (opcode == 5056) {
													isp--;
												...
												if (opcode == 5057) {
													...
													local803 = Static254.intStack[isp + 1];
													local809 = Static254.intStack[isp];
													Static254.intStack[isp++] = Static230.method3953(local809).anIntArray72[local803];
													continue;
												}
												if (opcode == 5058) {
												...
												if (opcode == 5062) {
													...
													local803 = Static254.intStack[isp + 1];
													local809 = Static254.intStack[isp];
													Static254.intStack[isp++] = Static235.method4045(local809).anIntArray31[local803];
													continue;
												}
												if (opcode == 5063) {
													isp -= 2;
													local803 = Static254.intStack[isp + 1];
													local809 = Static254.intStack[isp];
													Static254.intStack[isp++] = Static235.method4045(local809).anIntArray29[local803];
													continue;
												}
												if (opcode == 5064) {
													isp -= 2;
													...
													if (local803 == -1) {
														...
														Static254.intStack[isp++] = Static235.method4045(local809).method469(local803);
													}
													continue;
												}
												if (opcode == 5065) {
													...
													if (local803 == -1) {
														...
														Static254.intStack[isp++] = Static235.method4045(local809).method466(local803);
													}
													continue;
												}
												if (opcode == 5066) {
													isp--;
													local809 = Static254.intStack[isp];
													Static254.intStack[isp++] = Static230.method3953(local809).method767();
													continue;
												}
												if (opcode == 5067) {
													isp -= 2;
												...
												if (opcode < 5300) {
													...
													if (opcode == 5300) {
														...
														local803 = Static254.intStack[isp + 1];
														local809 = Static254.intStack[isp];
														Static241.setWindowMode(false, 3, local809, local803);
													...
													if (opcode == 5303) {
														...
														Static254.intStack[isp++] = local7800[local809].anInt4248;
														Static254.intStack[isp++] = local7800[local809].anInt4250;
														continue;
													}
													if (opcode == 5305) {
													...
													if (opcode == 5306) {
														Static254.intStack[isp++] = Static144.method2736();
														continue;
													}
													if (opcode == 5307) {
														isp--;
														...
														Static241.setWindowMode(false, local809, -1, -1);
														continue;
													}
													if (opcode == 5308) {
													...
													if (opcode == 5407) {
														isp--;
														local809 = Static107.anIntArrayArrayArray9[Static254.intStack[isp]].length >> 1;
														Static254.intStack[isp++] = local809;
														continue;
													}
													if (opcode == 5411) {
													...
													if (opcode == 5424) {
														...
														Static209.js5Archive8.method4506(Static55.anInt1736);
														Static209.js5Archive8.method4506(Static169.anInt4073);
														Static209.js5Archive8.method4506(Static85.anInt2261);
														Static209.js5Archive8.method4506(Static136.anInt3324);
														Static209.js5Archive8.method4506(Static254.anInt5556);
													...
													if (opcode == 5607) {
														Static254.intStack[isp++] = Static266.returnCode;
														continue;
													}
													if (opcode == 5608) {
													...
													if (opcode == 5610) {
														for (local809 = 0; local809 < 5; local809++) {
															Static3.stringStack[ssp++] = Static229.aClass100Array156.length > local809 ? Static229.aClass100Array156[local809].method3125() : Static72.aClass100_447;
														}
													...
													if (opcode == 6002) {
														isp--;
														Static53.method1293(Static254.intStack[isp] == 1);
														Static90.method1854();
														Static145.method2742();
													...
													if (opcode == 6003) {
														isp--;
														Static80.aBoolean231 = Static254.intStack[isp] == 1;
														Static269.method2218();
														Static203.write(GameShell.signLink);
														Static18.sentToServer = false;
														continue;
													...
													if (opcode == 6005) {
														isp--;
														Static250.aBoolean283 = Static254.intStack[isp] == 1;
														Static145.method2742();
														Static203.write(GameShell.signLink);
														Static18.sentToServer = false;
														continue;
													...
													if (opcode == 6007) {
														isp--;
														Static15.aBoolean33 = Static254.intStack[isp] == 1;
														Static203.write(GameShell.signLink);
														Static18.sentToServer = false;
														continue;
													}
													if (opcode == 6008) {
														isp--;
														Static11.aBoolean15 = Static254.intStack[isp] == 1;
														Static203.write(GameShell.signLink);
														Static18.sentToServer = false;
														continue;
													}
													if (opcode == 6009) {
														isp--;
														Static159.aBoolean189 = Static254.intStack[isp] == 1;
														Static203.write(GameShell.signLink);
														Static18.sentToServer = false;
														continue;
													}
													if (opcode == 6010) {
														isp--;
														Static209.aBoolean240 = Static254.intStack[isp] == 1;
														Static203.write(GameShell.signLink);
														Static18.sentToServer = false;
														continue;
													}
													...
													if (opcode == 6015) {
														isp--;
														Static71.aBoolean107 = Static254.intStack[isp] == 1;
														if (GlRenderer.enabled) {
															Static86.method1799();
														}
														Static203.write(GameShell.signLink);
													...
													if (opcode == 6019) {
														...
														if (local809 != Static12.anInt391) {
															if (Static12.anInt391 == 0 && Static221.anInt4363 != -1) {
																Static122.method2410(Static130.js5Archive6, Static221.anInt4363, local809);
													...
													if (opcode == 6021) {
														isp--;
														Static127.aBoolean160 = Static254.intStack[isp] == 1;
														Static269.method2218();
														continue;
													}
													if (opcode == 6023) {
													...
													if (opcode == 6024) {
														...
														Static102.windowMode = local809;
														Static203.write(GameShell.signLink);
														continue;
													}
													if (opcode == 6028) {
														isp--;
														Static64.aBoolean111 = Static254.intStack[isp] != 0;
														Static203.write(GameShell.signLink);
														continue;
													}
												} else if (opcode < 6200) {
													...
													if (opcode == 6103) {
														Static254.intStack[isp++] = Static80.aBoolean231 ? 1 : 0;
														continue;
													}
													if (opcode == 6105) {
														Static254.intStack[isp++] = Static250.aBoolean283 ? 1 : 0;
														continue;
													}
													if (opcode == 6106) {
													...
													if (opcode == 6107) {
														Static254.intStack[isp++] = Static15.aBoolean33 ? 1 : 0;
														continue;
													}
													if (opcode == 6108) {
														Static254.intStack[isp++] = Static11.aBoolean15 ? 1 : 0;
														continue;
													}
													if (opcode == 6109) {
														Static254.intStack[isp++] = Static159.aBoolean189 ? 1 : 0;
														continue;
													}
													if (opcode == 6110) {
														Static254.intStack[isp++] = Static209.aBoolean240 ? 1 : 0;
														continue;
													}
													if (opcode == 6111) {
														Static254.intStack[isp++] = Static139.anInt3451;
														continue;
													}
													if (opcode == 6112) {
													...
													if (opcode == 6115) {
														Static254.intStack[isp++] = Static71.aBoolean107 ? 1 : 0;
														continue;
													}
													if (opcode == 6116) {
													...
													if (opcode == 6118) {
														Static254.intStack[isp++] = Static125.anInt3104;
														continue;
													}
													if (opcode == 6119) {
														Static254.intStack[isp++] = Static12.anInt391;
														continue;
													}
													if (opcode == 6120) {
														Static254.intStack[isp++] = Static30.anInt978;
														continue;
													}
													if (opcode == 6121) {
														if (GlRenderer.enabled) {
													...
													if (opcode == 6123) {
														Static254.intStack[isp++] = Static76.method1644();
														continue;
													}
													if (opcode == 6124) {
													...
													if (opcode == 6128) {
														Static254.intStack[isp++] = Static64.aBoolean111 ? 1 : 0;
														continue;
													}
												} else if (opcode < 6300) {
													if (opcode == 6200) {
													...
													if (opcode == 6405) {
														Static254.intStack[isp++] = Static87.method1802() ? 1 : 0;
														continue;
													}
													if (opcode == 6406) {
														Static254.intStack[isp++] = Static267.method4527() ? 1 : 0;
														continue;
													}
												} else if (opcode < 6600) {
													if (opcode == 6500) {
													...
													if (opcode == 6501) {
														...
														if (local10191 == null) {
															...
															Static254.intStack[isp++] = local10191.anInt382;
															Static254.intStack[isp++] = local10191.anInt381;
															Static3.stringStack[ssp++] = local10191.aClass100_69;
															...
															Static254.intStack[isp++] = local10191.anInt379;
														}
														continue;
													}
													if (opcode == 6502) {
													...
													if (opcode == 6503) {
														...
														local809 = Static254.intStack[isp];
														if (Static244.gameState == 10 && Static219.anInt4937 == 0 && Static184.loginStep == 0 && Static179.accountCreationStep == 0) {
															Static254.intStack[isp++] = Static176.method3303(local809) ? 1 : 0;
															continue;
														}
														Static254.intStack[isp++] = 0;
														continue;
													...
													if (opcode == 6504) {
														isp--;
														Static164.anInt3988 = Static254.intStack[isp];
														Static203.write(GameShell.signLink);
														continue;
													}
													if (opcode == 6505) {
														Static254.intStack[isp++] = Static164.anInt3988;
														continue;
													}
													if (opcode == 6506) {
														isp--;
														...
														if (local10440 == null) {
															...
															Static254.intStack[isp++] = local10440.anInt381;
															...
															Static254.intStack[isp++] = local10440.anInt379;
														}
														continue;
													}
													if (opcode == 6507) {
											...
											local5294 = Static110.method2277(local803);
											if (local5294.method2078()) {
												Static3.stringStack[ssp++] = Static123.method2417(local809).method2802(local5294.aClass100_544, local803);
											} else {
												Static254.intStack[isp++] = Static123.method2417(local809).method2798(local803, local5294.anInt2667);
											}
											continue;
										}
									} else if (opcode == 4400) {
										...
										local5294 = Static110.method2277(local803);
										if (local5294.method2078()) {
											Static3.stringStack[ssp++] = Static271.method4601(local809).method3430(local5294.aClass100_544, local803);
										} else {
											Static254.intStack[isp++] = Static271.method4601(local809).method3423(local5294.anInt2667, local803);
										}
										continue;
									}
								} else {
									if (opcode == 4100) {
										...
										isp--;
										local803 = Static254.intStack[isp];
										Static3.stringStack[ssp++] = Static34.concatenate(new JagString[] { local609, Static123.parseInt(local803) });
										continue;
									}
									if (opcode == 4101) {
										ssp -= 2;
										local2522 = Static3.stringStack[ssp + 1];
										local609 = Static3.stringStack[ssp];
										Static3.stringStack[ssp++] = Static34.concatenate(new JagString[] { local609, local2522 });
										continue;
									}
									if (opcode == 4102) {
										ssp--;
										...
										isp--;
										local803 = Static254.intStack[isp];
										Static3.stringStack[ssp++] = Static34.concatenate(new JagString[] { local609, Static110.method2285(local803) });
										continue;
									}
									if (opcode == 4103) {
										ssp--;
										local609 = Static3.stringStack[ssp];
										Static3.stringStack[ssp++] = local609.toLowerCase();
										continue;
									}
									if (opcode == 4104) {
										isp--;
										...
										Static3.stringStack[ssp++] = Static34.concatenate(new JagString[] { Static123.parseInt(local652), Static163.aClass100_767, Static34.aClass100Array40[local4859], Static163.aClass100_767, Static123.parseInt(local1087) });
										continue;
									}
									if (opcode == 4105) {
										ssp -= 2;
									...
									if (opcode == 4106) {
										isp--;
										local809 = Static254.intStack[isp];
										Static3.stringStack[ssp++] = Static123.parseInt(local809);
										continue;
									}
									if (opcode == 4107) {
										ssp -= 2;
									...
									if (opcode == 4108) {
										...
										local1052 = Static254.intStack[isp + 1];
										local803 = Static254.intStack[isp];
										Static254.intStack[isp++] = Static148.method2768(local1052).method2860(local609, local803);
										continue;
									}
									if (opcode == 4109) {
										isp -= 2;
										...
										local1052 = Static254.intStack[isp + 1];
										local803 = Static254.intStack[isp];
										Static254.intStack[isp++] = Static148.method2768(local1052).method2856(local609, local803);
										continue;
									}
									if (opcode == 4110) {
										ssp -= 2;
									...
									if (opcode == 4111) {
										ssp--;
										local609 = Static3.stringStack[ssp];
										Static3.stringStack[ssp++] = Static218.method2862(local609);
										continue;
									}
									if (opcode == 4112) {
										ssp--;
										...
										Static3.stringStack[ssp++] = local609.method3128(local803);
										continue;
									}
									if (opcode == 4113) {
										isp--;
										local809 = Static254.intStack[isp];
										Static254.intStack[isp++] = Static273.method3213(local809) ? 1 : 0;
										continue;
									}
									if (opcode == 4114) {
										isp--;
										local809 = Static254.intStack[isp];
										Static254.intStack[isp++] = Static83.method433(local809) ? 1 : 0;
										continue;
									}
									if (opcode == 4115) {
										isp--;
										local809 = Static254.intStack[isp];
										Static254.intStack[isp++] = Static258.method4428(local809) ? 1 : 0;
										continue;
									}
									if (opcode == 4116) {
										isp--;
										local809 = Static254.intStack[isp];
										Static254.intStack[isp++] = Static24.method671(local809) ? 1 : 0;
										continue;
									}
									if (opcode == 4117) {
										ssp--;
										...
										if (local609 == null) {
											...
											Static254.intStack[isp++] = local609.length();
										}
										continue;
									}
									if (opcode == 4118) {
										...
										local803 = Static254.intStack[isp];
										local1052 = Static254.intStack[isp + 1];
										Static3.stringStack[ssp++] = local609.substring(local1052, local803);
										continue;
									}
									if (opcode == 4119) {
										ssp--;
									...
									if (opcode == 4120) {
										...
										local803 = Static254.intStack[isp];
										local1052 = Static254.intStack[isp + 1];
										Static254.intStack[isp++] = local609.method3135(local803, local1052);
										continue;
									}
									if (opcode == 4121) {
										ssp -= 2;
										...
										isp--;
										local1052 = Static254.intStack[isp];
										Static254.intStack[isp++] = local609.method3146(local2522, local1052);
										continue;
									}
									if (opcode == 4122) {
										isp--;
										local809 = Static254.intStack[isp];
										Static254.intStack[isp++] = Static231.method3984(local809);
										continue;
									}
									if (opcode == 4123) {
										isp--;
										local809 = Static254.intStack[isp];
										Static254.intStack[isp++] = Static143.method2733(local809);
										continue;
									}
									if (opcode == 4124) {
										isp--;
										...
										isp--;
										local803 = Static254.intStack[isp];
										Static3.stringStack[ssp++] = Static182.method3360(Static141.anInt3470, local12388, 0, (long) local803);
										continue;
									}
								}
							}
							...
							if (opcode == 1000) {
								isp -= 4;
								local1182.baseX = Static254.intStack[isp];
								local1182.baseY = Static254.intStack[isp + 1];
							...
							if (opcode == 1001) {
								isp -= 4;
								local1182.baseWidth = Static254.intStack[isp];
								local1182.anInt488 = Static254.intStack[isp + 1];
							...
							if (opcode == 1004) {
								isp -= 2;
								local1182.anInt473 = Static254.intStack[isp];
								local1182.anInt442 = Static254.intStack[isp + 1];
								Static43.method1143(local1182);
								Static74.method1625(local1182);
								if (local1182.anInt452 == 0) {
									Static17.method531(local1182, false);
							...
							if (opcode == 1005) {
								isp--;
								local1182.aBoolean29 = Static254.intStack[isp] == 1;
								continue;
							}
						}
					}
			...
			if (script.aClass100_880 == null) {
				if (Static83.modeWhere != 0) {
					Static103.method2231(Static72.aClass100_447, 0, Static136.aClass100_633);
				}
				Static89.report("CS2 - scr:" + script.aLong192 + " op:" + local44, local14378);
			} else {
				@Pc(14385) JagString local14385 = Static87.method1804(30);
				local14385.method3113(Static219.aClass100_928).method3113(script.aClass100_880);
				for (cycles = Static138.fp - 1; cycles >= 0; cycles--) {
					local14385.method3113(Static40.aClass100_253).method3113(Static67.callStack[cycles].script.aClass100_880);
				}
				if (local44 == 40) {
					cycles = intOperands[pc];
					local14385.method3113(Static176.aClass100_802).method3113(Static123.parseInt(cycles));
				}
				if (Static83.modeWhere != 0) {
					Static103.method2231(Static72.aClass100_447, 0, Static34.concatenate(new JagString[] { Static167.aClass100_780, script.aClass100_880 }));
				}
				Static89.report("CS2 - scr:" + script.aLong192 + " op:" + local44 + new String(local14385.method3148()), local14378);
			}
		}
	}
