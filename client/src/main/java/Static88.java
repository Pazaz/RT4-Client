...
public final class Static88 {
			...
			nextOp: while (true) {
				...
				if (opcode < 100) {
					...
					if (opcode == 37) {
						id = intOperands[pc];
						ssp -= id;
						string = JagString.method2355(ssp, id, Static3.stringStack);
				...
				if (opcode < 300) {
					if (opcode == 100) {
						...
						if (local803 != 0) {
							local1063 = InterfaceList.getComponent(type);
					...
					if (opcode == 102) {
						isp--;
						component = InterfaceList.getComponent(Static254.intStack[isp]);
					...
					if (opcode == 201) {
						isp--;
						type = Static254.intStack[isp];
						local1204 = InterfaceList.getComponent(type);
						if (local1204 == null) {
							Static254.intStack[isp++] = 0;
						} else {
							Static254.intStack[isp++] = 1;
					...
					if (opcode < 500) {
						if (opcode == 403) {
							...
							for (local1052 = 0; local1052 < Static204.anIntArray425.length; local1052++) {
								if (type == Static204.anIntArray425[local1052]) {
									PlayerList.self.appearance.method1953(local1052, local803);
									continue nextOp;
								}
							}
							local1052 = 0;
						...
						if (opcode == 404) {
							...
							type = Static254.intStack[isp];
							local803 = Static254.intStack[isp + 1];
							PlayerList.self.appearance.method1951(type, local803);
							continue;
						}
						if (opcode == 410) {
							isp--;
							...
							if (opcode >= 1100 && opcode < 1200 || !(opcode < 2100 || opcode >= 2200)) {
								...
								if (opcode == 1200 || opcode == 1205) {
									...
									if (local803 == -1) {
										...
										@Pc(13416) ObjType local13416 = ObjTypeList.get(local803);
								...
								if (opcode < 1600) {
									...
									if (opcode == 3101) {
										isp -= 2;
										Player.animate(Static254.intStack[isp + 1], Static254.intStack[isp], PlayerList.self);
										continue;
									}
									if (opcode == 3103) {
									...
									if (opcode == 3104) {
										...
										Protocol.outboundBuffer.p4(local803);
										continue;
									}
									if (opcode == 3105) {
										ssp--;
									...
									if (opcode == 3108) {
										...
										type = Static254.intStack[isp];
										local1052 = Static254.intStack[isp + 2];
										local1063 = InterfaceList.getComponent(local1052);
									...
									if (opcode == 3110) {
										...
										Protocol.outboundBuffer.p2(type);
										continue;
									}
								} else if (opcode < 3300) {
									if (opcode == 3200) {
										isp -= 3;
										SoundPlayer.play(Static254.intStack[isp + 1], Static254.intStack[isp], Static254.intStack[isp + 2]);
										continue;
									}
									if (opcode == 3201) {
										isp--;
									...
									if (opcode == 3304) {
										isp--;
										type = Static254.intStack[isp];
										Static254.intStack[isp++] = InvTypeList.list(type).size;
										continue;
									}
									if (opcode == 3305) {
										isp--;
									...
									if (opcode == 3312) {
										Static254.intStack[isp++] = LoginManager.mapMembers ? 1 : 0;
										continue;
									}
									if (opcode == 3313) {
										isp -= 2;
									...
									if (opcode == 3316) {
										if (LoginManager.staffModLevel < 2) {
											...
											Static254.intStack[isp++] = LoginManager.staffModLevel;
										}
										continue;
									}
									if (opcode == 3317) {
									...
									if (opcode == 3324) {
										if (LoginManager.playerModLevel >= 5 && LoginManager.playerModLevel <= 9) {
											Static254.intStack[isp++] = LoginManager.playerModLevel;
											continue;
										}
										Static254.intStack[isp++] = 0;
										continue;
									...
									if (opcode == 3325) {
										Static254.intStack[isp++] = LoginManager.playerMember ? 1 : 0;
										continue;
									}
									if (opcode == 3326) {
										Static254.intStack[isp++] = PlayerList.self.anInt1652;
										continue;
									}
									if (opcode == 3327) {
										Static254.intStack[isp++] = PlayerList.self.appearance.aBoolean141 ? 1 : 0;
										continue;
									}
									if (opcode == 3328) {
										Static254.intStack[isp++] = LoginManager.playerUnderage && !LoginManager.parentalChatConsent ? 1 : 0;
										continue;
									}
									if (opcode == 3329) {
										Static254.intStack[isp++] = LoginManager.mapQuickChat ? 1 : 0;
										continue;
									}
									if (opcode == 3330) {
										isp--;
									...
									if (opcode == 3333) {
										Static254.intStack[isp++] = LoginManager.anInt39;
										continue;
									}
									if (opcode == 3335) {
										Static254.intStack[isp++] = client.language;
										continue;
									}
									if (opcode == 3336) {
										isp -= 4;
									...
									if (opcode == 3337) {
										Static254.intStack[isp++] = client.affiliate;
										continue;
									}
								} else if (opcode < 3500) {
									...
									if (opcode == 3400) {
										...
										type = Static254.intStack[isp];
										local803 = Static254.intStack[isp + 1];
										local3422 = EnumTypeList.get(type);
									...
									if (opcode == 3408) {
										...
										local652 = Static254.intStack[isp + 3];
										local1052 = Static254.intStack[isp + 2];
										@Pc(3469) EnumType local3469 = EnumTypeList.get(local1052);
									...
									if (opcode == 3409) {
										...
										@Pc(3549) EnumType local3549 = EnumTypeList.get(local803);
									...
									if (opcode == 3411) {
										isp--;
										type = Static254.intStack[isp];
										@Pc(3645) EnumType local3645 = EnumTypeList.get(type);
									...
									if (opcode == 3629) {
										Static254.intStack[isp++] = client.country;
										continue;
									}
								} else if (opcode < 4000) {
									if (opcode == 3903) {
									...
									if (opcode < 4300) {
										if (opcode == 4200) {
											isp--;
											type = Static254.intStack[isp];
											Static3.stringStack[ssp++] = ObjTypeList.get(type).name;
											continue;
										}
										...
										if (opcode == 4201) {
											...
											type = Static254.intStack[isp];
											local803 = Static254.intStack[isp + 1];
											local11269 = ObjTypeList.get(type);
										...
										if (opcode == 4203) {
											isp--;
											type = Static254.intStack[isp];
											Static254.intStack[isp++] = ObjTypeList.get(type).cost;
											continue;
										}
										if (opcode == 4204) {
											isp--;
											type = Static254.intStack[isp];
											Static254.intStack[isp++] = ObjTypeList.get(type).stackable == 1 ? 1 : 0;
											continue;
										}
										...
										if (opcode == 4205) {
											isp--;
											type = Static254.intStack[isp];
											local11417 = ObjTypeList.get(type);
										...
										if (opcode == 4207) {
											isp--;
											type = Static254.intStack[isp];
											Static254.intStack[isp++] = ObjTypeList.get(type).members ? 1 : 0;
											continue;
										}
										if (opcode == 4208) {
											isp -= 2;
											type = Static254.intStack[isp];
											local803 = Static254.intStack[isp + 1];
											local5294 = ParamTypeList.get(local803);
											if (local5294.isString()) {
												Static3.stringStack[ssp++] = ObjTypeList.get(type).method1819(local5294.defaultString, local803);
											} else {
												Static254.intStack[isp++] = ObjTypeList.get(type).getParam(local5294.defaultInt, local803);
											}
											continue;
										}
										if (opcode == 4210) {
										...
										if (opcode == 4300) {
											...
											local5294 = ParamTypeList.get(local803);
											if (local5294.isString()) {
												Static3.stringStack[ssp++] = NpcTypeList.get(type).getParam(local803, local5294.defaultString);
											} else {
												Static254.intStack[isp++] = NpcTypeList.get(type).getParam(local803, local5294.defaultInt);
											}
											continue;
										}
									} else if (opcode >= 4500) {
										if (opcode >= 4600) {
											if (opcode < 5100) {
												...
												if (opcode == 5001) {
													...
													Protocol.outboundBuffer.p1(Static59.anInt1812);
													Protocol.outboundBuffer.p1(Static49.anInt1459);
													Protocol.outboundBuffer.p1(Static84.anInt2256);
													continue;
												}
												if (opcode == 5002) {
													ssp--;
													...
													Protocol.outboundBuffer.p8(string.encode37());
													Protocol.outboundBuffer.p1(local803 - 1);
													Protocol.outboundBuffer.p1(local1052);
													continue;
												}
												if (opcode == 5003) {
													local2522 = null;
												...
												if (opcode == 5009) {
													...
													if (LoginManager.staffModLevel != 0 || (!LoginManager.playerUnderage || LoginManager.parentalChatConsent) && !LoginManager.mapQuickChat) {
														...
														Protocol.outboundBuffer.p1(0);
														local1052 = Protocol.outboundBuffer.offset;
														Protocol.outboundBuffer.p8(string.encode37());
														Static146.method2748(Protocol.outboundBuffer, local2522);
														Protocol.outboundBuffer.p1len(Protocol.outboundBuffer.offset - local1052);
													}
													continue;
												}
												if (opcode == 5010) {
												...
												if (opcode == 5051) {
													isp--;
													type = Static254.intStack[isp];
													local6378 = QuickChatCatTypeList.method4045(type);
												...
												if (opcode == 5052) {
													...
													type = Static254.intStack[isp];
													local803 = Static254.intStack[isp + 1];
													@Pc(6416) QuickChatCatType local6416 = QuickChatCatTypeList.method4045(type);
												...
												if (opcode == 5054) {
													...
													local803 = Static254.intStack[isp + 1];
													type = Static254.intStack[isp];
													Static254.intStack[isp++] = QuickChatCatTypeList.method4045(type).anIntArray32[local803];
													continue;
												}
												if (opcode == 5055) {
													isp--;
													type = Static254.intStack[isp];
													Static3.stringStack[ssp++] = QuickChatPhraseTypeList.get(type).method769();
													continue;
												}
												if (opcode == 5056) {
													isp--;
													type = Static254.intStack[isp];
													@Pc(6527) QuickChatPhraseType local6527 = QuickChatPhraseTypeList.get(type);
												...
												if (opcode == 5057) {
													...
													local803 = Static254.intStack[isp + 1];
													type = Static254.intStack[isp];
													Static254.intStack[isp++] = QuickChatPhraseTypeList.get(type).anIntArray72[local803];
													continue;
												}
												if (opcode == 5058) {
												...
												if (opcode == 5062) {
													...
													local803 = Static254.intStack[isp + 1];
													type = Static254.intStack[isp];
													Static254.intStack[isp++] = QuickChatCatTypeList.method4045(type).anIntArray31[local803];
													continue;
												}
												if (opcode == 5063) {
													isp -= 2;
													local803 = Static254.intStack[isp + 1];
													type = Static254.intStack[isp];
													Static254.intStack[isp++] = QuickChatCatTypeList.method4045(type).anIntArray29[local803];
													continue;
												}
												if (opcode == 5064) {
													isp -= 2;
													...
													if (local803 == -1) {
														...
														Static254.intStack[isp++] = QuickChatCatTypeList.method4045(type).method469(local803);
													}
													continue;
												}
												if (opcode == 5065) {
													...
													if (local803 == -1) {
														...
														Static254.intStack[isp++] = QuickChatCatTypeList.method4045(type).method466(local803);
													}
													continue;
												}
												if (opcode == 5066) {
													isp--;
													type = Static254.intStack[isp];
													Static254.intStack[isp++] = QuickChatPhraseTypeList.get(type).method767();
													continue;
												}
												if (opcode == 5067) {
													isp -= 2;
													local803 = Static254.intStack[isp + 1];
													type = Static254.intStack[isp];
													local1052 = QuickChatPhraseTypeList.get(type).method765(local803);
												...
												if (opcode == 5070) {
													...
													local1052 = Static254.intStack[isp + 2];
													local803 = Static254.intStack[isp + 1];
													@Pc(6996) QuickChatPhraseType local6996 = QuickChatPhraseTypeList.get(type);
												...
												if (opcode < 5300) {
													...
													if (opcode == 5206) {
														...
														if (local7264 == null) {
															...
															Static3.stringStack[ssp++] = local7264.group;
														}
														continue;
													}
													...
													if (opcode == 5209) {
														Static254.intStack[isp++] = WorldMap.originX + WorldMap.anInt435;
														Static254.intStack[isp++] = WorldMap.originZ + WorldMap.length - WorldMap.anInt919 - 1;
														continue;
													}
													if (opcode == 5210) {
													...
													if (opcode == 5212) {
														...
														if (type == -1) {
															...
															local2522 = WorldMap.labels.aClass100Array153[type];
															local1052 = WorldMap.labels.method3894(type);
														}
													...
													if (opcode == 5218) {
														...
														if (local7293 == null) {
															...
															Static254.intStack[isp++] = local7293.defaultZoom;
														}
														continue;
													}
													if (opcode == 5219) {
													...
													if (opcode == 5220) {
														Static254.intStack[isp++] = WorldMap.loadPercentage == 100 ? 1 : 0;
														continue;
													}
												} else if (opcode < 5400) {
													if (opcode == 5300) {
													...
													if (opcode == 5305) {
														local803 = Preferences.fullScreenHeight;
														type = Preferences.fullScreenWidth;
														local1052 = -1;
													...
													if (opcode == 5308) {
														Static254.intStack[isp++] = Preferences.favoriteWorlds;
														continue;
													}
													if (opcode == 5309) {
														isp--;
														...
														Preferences.favoriteWorlds = type;
													...
													if (opcode == 5401) {
														isp -= 2;
														client.aShortArray88[Static254.intStack[isp]] = (short) Static105.method2253(Static254.intStack[isp + 1]);
														Static211.method924();
													...
													if (opcode == 5607) {
														Static254.intStack[isp++] = LoginManager.reply;
														continue;
													}
													if (opcode == 5608) {
														Static254.intStack[isp++] = LoginManager.hopTime;
														continue;
													}
													if (opcode == 5609) {
														Static254.intStack[isp++] = CreateManager.reply;
														continue;
													}
													if (opcode == 5610) {
													...
													if (opcode == 5611) {
														Static254.intStack[isp++] = LoginManager.disallowResult;
														continue;
													}
												} else if (opcode < 6100) {
													if (opcode == 6001) {
													...
													if (opcode == 6002) {
														isp--;
														Preferences.setAllVisibleLevels(Static254.intStack[isp] == 1);
														LocTypeList.clear();
														Static145.method2742();
													...
													if (opcode == 6003) {
														isp--;
														Preferences.removeRoofsSelectively = Static254.intStack[isp] == 1;
														Static269.method2218();
														Preferences.write(GameShell.signLink);
														Preferences.sentToServer = false;
														continue;
													...
													if (opcode == 6005) {
														isp--;
														Preferences.showGroundDecorations = Static254.intStack[isp] == 1;
														Static145.method2742();
														Preferences.write(GameShell.signLink);
														Preferences.sentToServer = false;
														continue;
													...
													if (opcode == 6006) {
														isp--;
														Preferences.highDetailTextures = Static254.intStack[isp] == 1;
													...
													if (opcode == 6007) {
														isp--;
														Preferences.manyIdleAnimations = Static254.intStack[isp] == 1;
														Preferences.write(GameShell.signLink);
														Preferences.sentToServer = false;
														continue;
													}
													if (opcode == 6008) {
														isp--;
														Preferences.flickeringEffectsOn = Static254.intStack[isp] == 1;
														Preferences.write(GameShell.signLink);
														Preferences.sentToServer = false;
														continue;
													}
													if (opcode == 6009) {
														isp--;
														Preferences.manyGroundTextures = Static254.intStack[isp] == 1;
														Preferences.write(GameShell.signLink);
														Preferences.sentToServer = false;
														continue;
													}
													if (opcode == 6010) {
														isp--;
														Preferences.characterShadowsOn = Static254.intStack[isp] == 1;
														Preferences.write(GameShell.signLink);
														Preferences.sentToServer = false;
														continue;
													}
													if (opcode == 6011) {
														...
														Preferences.sceneryShadowsType = type;
														Preferences.write(GameShell.signLink);
														Preferences.sentToServer = false;
														continue;
													}
													...
													if (opcode == 6014) {
														isp--;
														Preferences.highWaterDetail = Static254.intStack[isp] == 1;
														if (GlRenderer.enabled) {
															Static145.method2742();
														}
														Preferences.write(GameShell.signLink);
													...
													if (opcode == 6015) {
														isp--;
														Preferences.fogEnabled = Static254.intStack[isp] == 1;
														if (GlRenderer.enabled) {
															Static86.setInstantFade();
														}
														Preferences.write(GameShell.signLink);
													...
													if (opcode == 6016) {
														...
														Preferences.antiAliasingMode = type;
														continue;
													}
													if (opcode == 6017) {
														isp--;
														Preferences.stereo = Static254.intStack[isp] == 1;
														Static211.method930();
														Preferences.write(GameShell.signLink);
														Preferences.sentToServer = false;
														continue;
													...
													if (opcode == 6018) {
														...
														Preferences.soundEffectVolume = type;
														Preferences.write(GameShell.signLink);
														Preferences.sentToServer = false;
														continue;
													}
													if (opcode == 6019) {
														...
														if (type != Preferences.musicVolume) {
															if (Preferences.musicVolume == 0 && MusicPlayer.groupId != -1) {
																Static122.method2410(client.js5Archive6, MusicPlayer.groupId, type);
													...
													if (opcode == 6020) {
														...
														Preferences.ambientSoundsVolume = type;
														Preferences.write(GameShell.signLink);
														Preferences.sentToServer = false;
														continue;
													}
													...
													if (opcode == 6024) {
														...
														Preferences.windowMode = type;
														Preferences.write(GameShell.signLink);
														continue;
													}
													if (opcode == 6028) {
														isp--;
														Preferences.cursorsEnabled = Static254.intStack[isp] != 0;
														Preferences.write(GameShell.signLink);
														continue;
													}
												} else if (opcode < 6200) {
													if (opcode == 6101) {
														Static254.intStack[isp++] = Preferences.brightness;
														continue;
													}
													if (opcode == 6102) {
														Static254.intStack[isp++] = SceneGraph.allLevelsAreVisible() ? 1 : 0;
														continue;
													}
													if (opcode == 6103) {
														Static254.intStack[isp++] = Preferences.removeRoofsSelectively ? 1 : 0;
														continue;
													}
													if (opcode == 6105) {
														Static254.intStack[isp++] = Preferences.showGroundDecorations ? 1 : 0;
														continue;
													}
													if (opcode == 6106) {
														Static254.intStack[isp++] = Preferences.highDetailTextures ? 1 : 0;
														continue;
													}
													if (opcode == 6107) {
														Static254.intStack[isp++] = Preferences.manyIdleAnimations ? 1 : 0;
														continue;
													}
													if (opcode == 6108) {
														Static254.intStack[isp++] = Preferences.flickeringEffectsOn ? 1 : 0;
														continue;
													}
													if (opcode == 6109) {
														Static254.intStack[isp++] = Preferences.manyGroundTextures ? 1 : 0;
														continue;
													}
													if (opcode == 6110) {
														Static254.intStack[isp++] = Preferences.characterShadowsOn ? 1 : 0;
														continue;
													}
													if (opcode == 6111) {
														Static254.intStack[isp++] = Preferences.sceneryShadowsType;
														continue;
													}
													if (opcode == 6112) {
														Static254.intStack[isp++] = Preferences.highDetailLighting ? 1 : 0;
														continue;
													}
													if (opcode == 6114) {
														Static254.intStack[isp++] = Preferences.highWaterDetail ? 1 : 0;
														continue;
													}
													if (opcode == 6115) {
														Static254.intStack[isp++] = Preferences.fogEnabled ? 1 : 0;
														continue;
													}
													if (opcode == 6116) {
														Static254.intStack[isp++] = Preferences.antiAliasingMode;
														continue;
													}
													if (opcode == 6117) {
														Static254.intStack[isp++] = Preferences.stereo ? 1 : 0;
														continue;
													}
													if (opcode == 6118) {
														Static254.intStack[isp++] = Preferences.soundEffectVolume;
														continue;
													}
													if (opcode == 6119) {
														Static254.intStack[isp++] = Preferences.musicVolume;
														continue;
													}
													if (opcode == 6120) {
														Static254.intStack[isp++] = Preferences.ambientSoundsVolume;
														continue;
													}
													if (opcode == 6121) {
														if (GlRenderer.enabled) {
													...
													if (opcode == 6123) {
														Static254.intStack[isp++] = Preferences.getParticleSetting();
														continue;
													}
													if (opcode == 6124) {
														Static254.intStack[isp++] = Preferences.windowMode;
														continue;
													}
													if (opcode == 6128) {
														Static254.intStack[isp++] = Preferences.cursorsEnabled ? 1 : 0;
														continue;
													}
												} else if (opcode < 6300) {
													if (opcode == 6200) {
													...
													if (opcode == 6500) {
														if (client.gameState == 10 && LoginManager.anInt4937 == 0 && LoginManager.step == 0 && CreateManager.step == 0) {
															Static254.intStack[isp++] = WorldList.fetch() == -1 ? 0 : 1;
															continue;
														}
														Static254.intStack[isp++] = 1;
														continue;
													...
													if (opcode == 6501) {
														...
														if (world == null) {
															...
															Static254.intStack[isp++] = world.id;
															Static254.intStack[isp++] = world.flags;
															Static3.stringStack[ssp++] = world.activity;
															local10247 = world.getWorldInfo();
															Static254.intStack[isp++] = local10247.flag;
															Static3.stringStack[ssp++] = local10247.name;
													...
													if (opcode == 6504) {
														isp--;
														Preferences.lastWorldId = Static254.intStack[isp];
														Preferences.write(GameShell.signLink);
														continue;
													}
													if (opcode == 6505) {
													...
													if (opcode == 6506) {
														...
														if (local10440 == null) {
															...
															Static3.stringStack[ssp++] = local10440.activity;
															@Pc(10458) Class32 local10458 = local10440.getWorldInfo();
															Static254.intStack[isp++] = local10458.flag;
															Static3.stringStack[ssp++] = local10458.name;
													...
													if (opcode == 6600) {
														isp--;
														Preferences.aBoolean63 = Static254.intStack[isp] == 1;
														Preferences.write(GameShell.signLink);
														continue;
													}
													if (opcode == 6601) {
														Static254.intStack[isp++] = Preferences.aBoolean63 ? 1 : 0;
														continue;
													}
												}
											}
											...
											local5294 = ParamTypeList.get(local803);
											if (local5294.isString()) {
												Static3.stringStack[ssp++] = StructTypeList.get(type).getParam(local5294.defaultString, local803);
											} else {
												Static254.intStack[isp++] = StructTypeList.get(type).getParam(local803, local5294.defaultInt);
											}
											continue;
										}
									} else if (opcode == 4400) {
										...
										local5294 = ParamTypeList.get(local803);
										if (local5294.isString()) {
											Static3.stringStack[ssp++] = LocTypeList.get(type).method3430(local5294.defaultString, local803);
										} else {
											Static254.intStack[isp++] = LocTypeList.get(type).getParam(local5294.defaultInt, local803);
										}
										continue;
									}
								} else {
									if (opcode == 4100) {
										...
										isp--;
										local803 = Static254.intStack[isp];
										Static3.stringStack[ssp++] = JagString.concatenate(new JagString[] { string, Static123.parseInt(local803) });
										continue;
									}
									if (opcode == 4101) {
										ssp -= 2;
										local2522 = Static3.stringStack[ssp + 1];
										string = Static3.stringStack[ssp];
										Static3.stringStack[ssp++] = JagString.concatenate(new JagString[] { string, local2522 });
										continue;
									}
									if (opcode == 4102) {
										ssp--;
										...
										isp--;
										local803 = Static254.intStack[isp];
										Static3.stringStack[ssp++] = JagString.concatenate(new JagString[] { string, Static110.method2285(local803) });
										continue;
									}
									if (opcode == 4103) {
										ssp--;
									...
									if (opcode == 4104) {
										...
										Static3.stringStack[ssp++] = JagString.concatenate(new JagString[] { Static123.parseInt(local652), Static163.aClass100_767, Static34.aClass100Array40[c], Static163.aClass100_767, Static123.parseInt(local1087) });
										continue;
									}
									if (opcode == 4105) {
										ssp -= 2;
									...
									if (opcode == 4124) {
										...
										isp--;
										local803 = Static254.intStack[isp];
										Static3.stringStack[ssp++] = Static182.valueToBase10String(client.language, local12388, 0, (long) local803);
										continue;
									}
								}
							}
	...
	public static World getNextWorld() {
		return WorldList.sorted.length > Static51.worldPos ? WorldList.sorted[Static51.worldPos++] : null;
	}
