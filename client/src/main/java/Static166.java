...
public final class Static166 {
	...
	public static final Class100 aClass100_778 = Static28.method790("Kampfstufe: ");

	@OriginalMember(owner = "client!nc", name = "e", descriptor = "Lclient!na;")
	public static final Class100 aClass100_779 = Static28.method790("underlay");
							...
							if (!local17 || local19 * 8 <= local150 && local150 < local19 * 8 + 8 && local155 >= local21 * 8 && local155 < local21 * 8 + 8) {
								...
								if (local202 != 0) {
									...
									if ((local202 & 0x4) == 4) {
										...
										local214--;
										@Pc(312) Class118 local312 = Static271.method4601(local214);
