...
public final class Static32 {
	...
	public static Class36_Sub1 aClass36_Sub1_1 = null;
	...
	public static void method865(@OriginalArg(0) int[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) Class8_Sub4_Sub1 arg2, @OriginalArg(4) int[] arg3) {
			...
			while (local24 != 0 && local30 < arg2.aClass147Array3.length) {
				if ((local24 & 0x1) != 0) {
					if (local20 == -1) {
						...
						@Pc(68) Class144 local68 = Static36.method941(local20);
