...
public final class Static82 {
	...
	private static final Class100 aClass100_479 = Static28.method790("Unable to find ");

	@OriginalMember(owner = "client!gi", name = "b", descriptor = "Lclient!na;")
	public static Class100 aClass100_478 = aClass100_479;

	@OriginalMember(owner = "client!gi", name = "c", descriptor = "I")
	public static int anInt2231 = 0;

	@OriginalMember(owner = "client!gi", name = "k", descriptor = "Lclient!na;")
	public static final Class100 aClass100_480 = Static28.method790("clignotant3:");

	@OriginalMember(owner = "client!gi", name = "l", descriptor = "Lclient!na;")
	public static final Class100 aClass100_481 = Static28.method790("blaugr-Un:");

	@OriginalMember(owner = "client!gi", name = "o", descriptor = "Lclient!na;")
	public static final Class100 aClass100_482 = Static28.method790("Chargement de la liste des serveurs");
	...
	public static Class3_Sub2_Sub1 method1764() {
		...
		if (Static239.aBoolean269) {
			local69 = new Class3_Sub2_Sub1_Sub2(Static124.anInt3080, Static227.anInt5091, Static274.anIntArray440[0], Static269.anIntArray252[0], Static254.anIntArray488[0], Static26.anIntArray66[0], local20);
		} else {
			local69 = new Class3_Sub2_Sub1_Sub1(Static124.anInt3080, Static227.anInt5091, Static274.anIntArray440[0], Static269.anIntArray252[0], Static254.anIntArray488[0], Static26.anIntArray66[0], local20);
		}
		Static75.method1631();
		return local69;
	}
