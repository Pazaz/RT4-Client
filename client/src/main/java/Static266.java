...
public final class Static266 {
	...
	public static final Class100 aClass100_1010 = Static28.method790("null");
	...
	public static final Class100 aClass100_1011 = Static28.method790("Lade Liste der Welten");
	...
	public static void method4193(@OriginalArg(0) Class31 arg0) {
		for (@Pc(2) int local2 = arg0.anInt1701; local2 <= arg0.anInt1713; local2++) {
			for (@Pc(9) int local9 = arg0.anInt1696; local9 <= arg0.anInt1698; local9++) {
				@Pc(22) Class3_Sub5 local22 = Static130.aClass3_Sub5ArrayArrayArray1[arg0.anInt1709][local2][local9];
				if (local22 != null) {
					@Pc(26) int local26;
