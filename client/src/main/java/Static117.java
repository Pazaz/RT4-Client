...
public final class Static117 {
	...
	private static boolean method2344(@OriginalArg(0) Class153 arg0) {
		if (!aBoolean149) {
	...
	public static Class3_Sub17 method2345(@OriginalArg(0) Class153 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		if (method2344(arg0)) {
	...
	private static void method2349(@OriginalArg(0) byte[] arg0) {
		...
		aClass78Array1 = new Class78[local17];
		for (local26 = 0; local26 < local17; local26++) {
			aClass78Array1[local26] = new Class78();
		}
