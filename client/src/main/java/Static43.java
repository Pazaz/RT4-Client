...
public final class Static43 {
	...
	public static final Class100 aClass100_333 = Static28.method790("Shift)2click ENABLED(Q");
	...
	public static final Class100 aClass100_334 = Static28.method790("Cache:");
	...
	public static boolean method1141(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) Class8 arg5, @OriginalArg(6) int arg6, @OriginalArg(7) long arg7, @OriginalArg(8) boolean arg8) {
		if (arg5 == null) {
			return true;
		}
	...
	public static void method1144(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) Class97 arg5) {
		@Pc(9) long local9 = 0L;
		if (arg3 == 0) {
		...
		@Pc(74) Class118 local74 = Static271.method4601(local70);
		...
		@Pc(102) Class8 local102 = null;
		if (arg3 == 0) {
			@Pc(110) Class77 local110 = Static110.method2276(arg2, arg1, arg0);
			if (local110 != null) {
			...
			@Pc(211) Class15 local211 = Static267.method4526(arg2, arg1, arg0);
			if (local211 != null) {
		...
		if (local57 == 2) {
			if (local100 instanceof Class8_Sub3) {
				((Class8_Sub3) local100).method1046();
			} else {
				Static9.method181(local74, 0, local92 + 4, 0, local57, arg1, arg0, arg4);
			}
			if (local102 instanceof Class8_Sub3) {
				((Class8_Sub3) local102).method1046();
			} else {
		...
		} else if (local100 instanceof Class8_Sub3) {
			((Class8_Sub3) local100).method1046();
		} else {
