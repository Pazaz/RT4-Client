...
public final class Static176 {
	...
	public static final Class100 aClass100_799 = Static28.method790("Fertigkeit: ");

	@OriginalMember(owner = "client!ob", name = "e", descriptor = "Lclient!na;")
	public static final Class100 aClass100_800 = Static28.method790("");

	@OriginalMember(owner = "client!ob", name = "o", descriptor = "Lclient!na;")
	private static final Class100 aClass100_801 = Static28.method790(")4a=");

	@OriginalMember(owner = "client!ob", name = "p", descriptor = "Lclient!na;")
	public static final Class100 aClass100_802 = Static28.method790("(U0a )2 non)2existant gosub script)2num: ");
	...
	public static boolean method3303(@OriginalArg(0) int arg0) {
		...
		if (local3 == null) {
			...
			@Pc(62) Class100 local62 = Static211.aClass100_230;
			if (Static83.anInt370 != 0) {
				local62 = Static34.method882(new Class100[] { Static31.aClass100_193, Static123.method2423(local3.anInt382 + 7000) });
			}
			@Pc(89) Class100 local89 = Static211.aClass100_230;
			if (Static47.aClass100_991 != null) {
				local89 = Static34.method882(new Class100[] { Static167.aClass100_783, Static47.aClass100_991 });
			}
		...
		for (local15 = 0; local15 < Static2.anInt7; local15++) {
			...
			if (local121 != local112) {
				...
				if (local133 == 2 && Static257.method523(Static55.anInt1735, local47, local147, local121)) {
					@Pc(172) Class118 local172 = Static271.method4601(local140);
					...
					if (Static260.anInt5014 == 1) {
						Static98.method1966(Static169.anInt4075, local121, Static34.method882(new Class100[] { Static34.aClass100_203, Static27.aClass100_164, local172.aClass100_830 }), local47, (short) 14, Static222.aClass100_937, local147);
						...
						if ((Static274.anInt4999 & 0x4) != 0 && (local363 == null || local172.method3423(local363.anInt2667, Static121.anInt3039) != local363.anInt2667)) {
							Static98.method1966(Static246.anInt5393, local121, Static34.method882(new Class100[] { Static78.aClass100_466, Static27.aClass100_164, local172.aClass100_830 }), local47, (short) 38, Static102.aClass100_545, local147);
						}
					} else {
						@Pc(228) Class100[] local228 = local172.aClass100Array130;
						...
						if (local228 != null) {
							for (local240 = 4; local240 >= 0; local240--) {
								if (local228[local240] != null) {
									...
									Static98.method1966(local268, local121, Static34.method882(new Class100[] { Static240.aClass100_1008, local172.aClass100_830 }), local47, local254, local228[local240], local147);
								}
							}
						}
						Static98.method1966(Static225.anInt5073, (long) local172.anInt4426, Static34.method882(new Class100[] { Static240.aClass100_1008, local172.aClass100_830 }), local47, (short) 1004, Static148.aClass100_675, local147);
					}
				}
				@Pc(514) int local514;
				@Pc(526) int local526;
				...
				if (local133 == 3) {
					...
					if (local931 != null) {
						for (@Pc(940) Class3_Sub2_Sub16 local940 = (Class3_Sub2_Sub16) local931.method2279(); local940 != null; local940 = (Class3_Sub2_Sub16) local931.method2286()) {
							...
							if (Static260.anInt5014 == 1) {
								Static98.method1966(Static169.anInt4075, (long) local240, Static34.method882(new Class100[] { Static34.aClass100_203, Static223.aClass100_947, local951.aClass100_495 }), local47, (short) 33, Static222.aClass100_937, local147);
							} else if (Static241.aBoolean302) {
								...
								if ((Static274.anInt4999 & 0x1) != 0 && (local1142 == null || local951.method1829(local1142.anInt2667, Static121.anInt3039) != local1142.anInt2667)) {
									Static98.method1966(Static246.anInt5393, (long) local240, Static34.method882(new Class100[] { Static78.aClass100_466, Static223.aClass100_947, local951.aClass100_495 }), local47, (short) 39, Static102.aClass100_545, local147);
								}
							} else {
								@Pc(997) Class100[] local997 = local951.aClass100Array72;
								if (Static208.aBoolean237) {
								...
								for (local514 = 4; local514 >= 0; local514--) {
									if (local997 != null && local997[local514] != null) {
										...
										Static98.method1966(local1041, (long) local240, Static34.method882(new Class100[] { Static8.aClass100_32, local951.aClass100_495 }), local47, local1025, local997[local514], local147);
									}
								}
								Static98.method1966(Static225.anInt5073, (long) local240, Static34.method882(new Class100[] { Static8.aClass100_32, local951.aClass100_495 }), local47, (short) 1002, Static148.aClass100_675, local147);
							}
						}
					}
				}
