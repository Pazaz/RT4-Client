...
public final class Static234 {
	...
	public static final Class100 aClass100_996 = Static28.method790("Zugewiesener Speicher)3");

	@OriginalMember(owner = "client!ta", name = "q", descriptor = "Lclient!na;")
	private static final Class100 aClass100_997 = Static28.method790("Choose Option");

	@OriginalMember(owner = "client!ta", name = "w", descriptor = "Lclient!na;")
	public static Class100 aClass100_998 = aClass100_997;
			...
			if ((local18 & 0x80) != 0) {
				...
				if (local147) {
					...
					if (local14.anInt3432 != -1 && local14.anInt3359 == Static83.anInt372) {
						...
						if (local227 != -1) {
							@Pc(236) Class144 local236 = Static36.method941(local227);
	...
	public static void method4018(@OriginalArg(0) Class3_Sub2_Sub1_Sub1[] arg0, @OriginalArg(2) Class153 arg1) {
		...
		for (@Pc(32) int local32 = 0; local32 < local30.length; local32++) {
			Static228.aClass69_120.method2282(Static210.method3713(new Class3_Sub15(Static119.aClass153_44.method4495(local25, local30[local32]))));
		}
	}
