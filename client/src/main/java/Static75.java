...
public final class Static75 {
	...
	public static final Class100 aClass100_462 = Static28.method790("Ihre Freunde)2Liste ist voll(Q Maximale Eintr-=ge: Mitglieder 200)4freie Spieler 100");
	...
	public static void method1629(@OriginalArg(1) boolean arg0) {
		...
		if (!Static230.aBoolean250) {
			local13 = Static57.aClass3_Sub15_Sub1_3.method2184();
			local20 = (Static223.anInt5028 - Static57.aClass3_Sub15_Sub1_3.anInt2792) / 16;
			Static72.anIntArrayArray14 = new int[local20][4];
			for (local26 = 0; local26 < local20; local26++) {
				for (local31 = 0; local31 < 4; local31++) {
					Static72.anIntArrayArray14[local26][local31] = Static57.aClass3_Sub15_Sub1_3.method2224();
				}
			}
			local26 = Static57.aClass3_Sub15_Sub1_3.method2180();
			local31 = Static57.aClass3_Sub15_Sub1_3.method2163();
			local60 = Static57.aClass3_Sub15_Sub1_3.method2184();
			local64 = Static57.aClass3_Sub15_Sub1_3.method2184();
			...
			for (local138 = (local31 - 6) / 8; local138 <= (local31 + 6) / 8; local138++) {
				for (local151 = (local60 - 6) / 8; local151 <= (local60 + 6) / 8; local151++) {
					...
					if (local100 && (local151 == 49 || local151 == 149 || local151 == 147 || local138 == 50 || local138 == 49 && local151 == 47)) {
						...
						Static238.anIntArray470[local20] = local169;
						Static36.anIntArray84[local20] = Static26.aClass153_16.method4482(Static34.method882(new Class100[] { Static103.aClass100_558, Static123.method2423(local138), Static86.aClass100_488, Static123.method2423(local151) }));
						Static172.anIntArray366[local20] = Static26.aClass153_16.method4482(Static34.method882(new Class100[] { Static270.aClass100_1090, Static123.method2423(local138), Static86.aClass100_488, Static123.method2423(local151) }));
						Static99.anIntArray239[local20] = Static26.aClass153_16.method4482(Static34.method882(new Class100[] { Static165.aClass100_772, Static123.method2423(local138), Static86.aClass100_488, Static123.method2423(local151) }));
						Static35.anIntArray82[local20] = Static26.aClass153_16.method4482(Static34.method882(new Class100[] { Static278.aClass100_1103, Static123.method2423(local138), Static86.aClass100_488, Static123.method2423(local151) }));
					}
					local20++;
				}
			}
		...
		local13 = Static57.aClass3_Sub15_Sub1_3.method2207();
		local20 = Static57.aClass3_Sub15_Sub1_3.method2207();
		local26 = Static57.aClass3_Sub15_Sub1_3.method2180();
		local31 = Static57.aClass3_Sub15_Sub1_3.method2207();
		...
		local60 = (Static223.anInt5028 - Static57.aClass3_Sub15_Sub1_3.anInt2792) / 16;
		Static72.anIntArrayArray14 = new int[local60][4];
		for (local64 = 0; local64 < local60; local64++) {
			for (local391 = 0; local391 < 4; local391++) {
				Static72.anIntArrayArray14[local64][local391] = Static57.aClass3_Sub15_Sub1_3.method2224();
			}
		}
		local64 = Static57.aClass3_Sub15_Sub1_3.method2163();
				...
				for (local151 = 0; local151 < 13; local151++) {
					...
					if (local169 != -1) {
						...
						if (local571 != -1) {
							...
							Static36.anIntArray84[local60] = Static26.aClass153_16.method4482(Static34.method882(new Class100[] { Static103.aClass100_558, Static123.method2423(local573), Static86.aClass100_488, Static123.method2423(local609) }));
							Static172.anIntArray366[local60] = Static26.aClass153_16.method4482(Static34.method882(new Class100[] { Static270.aClass100_1090, Static123.method2423(local573), Static86.aClass100_488, Static123.method2423(local609) }));
							Static99.anIntArray239[local60] = Static26.aClass153_16.method4482(Static34.method882(new Class100[] { Static165.aClass100_772, Static123.method2423(local573), Static86.aClass100_488, Static123.method2423(local609) }));
							Static35.anIntArray82[local60] = Static26.aClass153_16.method4482(Static34.method882(new Class100[] { Static278.aClass100_1103, Static123.method2423(local573), Static86.aClass100_488, Static123.method2423(local609) }));
							local60++;
						}
					}
				}
	...
	public static Class24 method1633(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(7) Class3_Sub5 local7 = Static130.aClass3_Sub5ArrayArrayArray1[arg0][arg1][arg2];
		if (local7 == null) {
			return null;
		} else {
			@Pc(14) Class24 local14 = local7.aClass24_1;
	...
	public static void method1634() {
		...
		if (Static164.anInt3985 == 195) {
			local15 = Static57.aClass3_Sub15_Sub1_3.method2212();
			local19 = local15 & 0x3;
			local23 = local15 >> 2;
			local27 = Static133.anIntArray453[local23];
			local31 = Static57.aClass3_Sub15_Sub1_3.method2229();
			...
			local15 = Static57.aClass3_Sub15_Sub1_3.method2192();
			local23 = Static57.aClass3_Sub15_Sub1_3.method2229();
			local27 = (local23 & 0x7) + Static180.anInt4264;
			local19 = (local23 >> 4 & 0x7) + Static115.anInt2940;
			local31 = Static57.aClass3_Sub15_Sub1_3.method2184();
			if (local19 >= 0 && local27 >= 0 && local19 < 104 && local27 < 104) {
				@Pc(122) Class8_Sub7 local122 = new Class8_Sub7();
				...
				if (Static159.aClass69ArrayArrayArray1[Static55.anInt1735][local19][local27] == null) {
					Static159.aClass69ArrayArrayArray1[Static55.anInt1735][local19][local27] = new Class69();
				}
			...
			if (Static164.anInt3985 == 121) {
				...
				local27 = local23 + Static57.aClass3_Sub15_Sub1_3.method2186();
				local31 = Static57.aClass3_Sub15_Sub1_3.method2186() + local19;
				local39 = Static57.aClass3_Sub15_Sub1_3.method2213();
				local45 = Static57.aClass3_Sub15_Sub1_3.method2163();
				local218 = Static57.aClass3_Sub15_Sub1_3.method2229() * 4;
				local224 = Static57.aClass3_Sub15_Sub1_3.method2229() * 4;
				local228 = Static57.aClass3_Sub15_Sub1_3.method2163();
				local232 = Static57.aClass3_Sub15_Sub1_3.method2163();
				local236 = Static57.aClass3_Sub15_Sub1_3.method2229();
				if (local236 == 255) {
					local236 = -1;
				}
				local247 = Static57.aClass3_Sub15_Sub1_3.method2229();
				if (local23 >= 0 && local19 >= 0 && local23 < 208 && local19 < 208 && local27 >= 0 && local31 >= 0 && local27 < 208 && local31 < 208 && local45 != 65535) {
					local31 *= 64;
					local27 = local27 * 64;
					local19 = local19 * 64;
					local23 = local23 * 64;
					local317 = new Class8_Sub6(local45, Static55.anInt1735, local23, local19, Static207.method3685(Static55.anInt1735, local23, local19) - local218, Static83.anInt372 + local228, local232 + Static83.anInt372, local236, local247, local39, local224);
				...
				local27 = Static57.aClass3_Sub15_Sub1_3.method2163();
				local31 = Static57.aClass3_Sub15_Sub1_3.method2229();
				local39 = Static57.aClass3_Sub15_Sub1_3.method2163();
				...
				if (Static164.anInt3985 == 202) {
					...
					local23 = local15 >> 2;
					local19 = local15 & 0x3;
					local27 = Static57.aClass3_Sub15_Sub1_3.method2229();
					local31 = (local27 >> 4 & 0x7) + Static115.anInt2940;
					local39 = (local27 & 0x7) + Static180.anInt4264;
					@Pc(605) byte local605 = Static57.aClass3_Sub15_Sub1_3.method2215();
					@Pc(609) byte local609 = Static57.aClass3_Sub15_Sub1_3.method2215();
					@Pc(613) byte local613 = Static57.aClass3_Sub15_Sub1_3.method2175();
					local228 = Static57.aClass3_Sub15_Sub1_3.method2184();
					local232 = Static57.aClass3_Sub15_Sub1_3.method2192();
					@Pc(625) byte local625 = Static57.aClass3_Sub15_Sub1_3.method2186();
					local247 = Static57.aClass3_Sub15_Sub1_3.method2163();
					local633 = Static57.aClass3_Sub15_Sub1_3.method2214();
				...
				if (Static164.anInt3985 == 14) {
					...
					local39 = Static57.aClass3_Sub15_Sub1_3.method2163();
					if (local23 >= 0 && local19 >= 0 && local23 < 104 && local19 < 104) {
						@Pc(710) Class69 local710 = Static159.aClass69ArrayArrayArray1[Static55.anInt1735][local23][local19];
						if (local710 != null) {
							for (@Pc(718) Class3_Sub2_Sub16 local718 = (Class3_Sub2_Sub16) local710.method2289(); local718 != null; local718 = (Class3_Sub2_Sub16) local710.method2288()) {
								@Pc(723) Class8_Sub7 local723 = local718.aClass8_Sub7_1;
					...
					local15 = Static57.aClass3_Sub15_Sub1_3.method2207();
					local23 = Static57.aClass3_Sub15_Sub1_3.method2212();
					local27 = Static180.anInt4264 + (local23 & 0x7);
					local19 = (local23 >> 4 & 0x7) + Static115.anInt2940;
					local31 = Static57.aClass3_Sub15_Sub1_3.method2192();
					local39 = Static57.aClass3_Sub15_Sub1_3.method2192();
					if (local19 >= 0 && local27 >= 0 && local19 < 104 && local27 < 104 && Static16.anInt549 != local15) {
						@Pc(812) Class8_Sub7 local812 = new Class8_Sub7();
					...
					if (local23 >= 0 && local19 >= 0 && local23 < 104 && local19 < 104 && local27 >= 0 && local31 >= 0 && local27 < 104 && local31 < 104 && local45 != 65535) {
						...
						local317 = new Class8_Sub6(local45, Static55.anInt1735, local23, local19, Static207.method3685(Static55.anInt1735, local23, local19) - local218, local228 + Static83.anInt372, local232 + Static83.anInt372, local236, local247, local39, local224);
					...
					local23 = Static115.anInt2940 * 2 + (local15 >> 4 & 0xF);
					local27 = Static57.aClass3_Sub15_Sub1_3.method2186() + local23;
					local31 = Static57.aClass3_Sub15_Sub1_3.method2186() + local19;
					local39 = Static57.aClass3_Sub15_Sub1_3.method2213();
					local45 = Static57.aClass3_Sub15_Sub1_3.method2213();
					local218 = Static57.aClass3_Sub15_Sub1_3.method2163();
					local224 = Static57.aClass3_Sub15_Sub1_3.method2186();
					local228 = Static57.aClass3_Sub15_Sub1_3.method2229() * 4;
					local232 = Static57.aClass3_Sub15_Sub1_3.method2163();
					local236 = Static57.aClass3_Sub15_Sub1_3.method2163();
					local247 = Static57.aClass3_Sub15_Sub1_3.method2229();
					local633 = Static57.aClass3_Sub15_Sub1_3.method2229();
					if (local247 == 255) {
						local247 = -1;
					}
					if (local23 >= 0 && local19 >= 0 && local23 < 208 && local19 < 208 && local27 >= 0 && local31 >= 0 && local27 < 208 && local31 < 208 && local218 != 65535) {
						...
						@Pc(1331) Class8_Sub6 local1331 = new Class8_Sub6(local218, Static55.anInt1735, local23, local19, Static207.method3685(Static55.anInt1735, local23, local19) - local224, local232 + Static83.anInt372, local236 + Static83.anInt372, local247, local633, local45, local228);
					...
					local218 = Static57.aClass3_Sub15_Sub1_3.method2229();
					local45 = local31 & 0x7;
					if (local23 >= 0 && local19 >= 0 && local23 < 104 && local19 < 104) {
						local224 = local39 + 1;
					...
					local27 = Static57.aClass3_Sub15_Sub1_3.method2163();
					if (local23 >= 0 && local19 >= 0 && local23 < 104 && local19 < 104) {
						@Pc(1565) Class69 local1565 = Static159.aClass69ArrayArrayArray1[Static55.anInt1735][local23][local19];
						if (local1565 != null) {
