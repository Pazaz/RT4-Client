...
public final class Class3_Sub1_Sub28 extends TextureOp {
	...
	public final void method4629(@OriginalArg(0) int arg0, @OriginalArg(1) Buffer arg1) {
		if (arg0 == 0) {
			this.anInt4580 = arg1.method2163();
		} else if (arg0 == 1) {
			this.anInt4577 = arg1.method2163();
		} else if (arg0 == 2) {
			this.anInt4584 = arg1.method2163();
		}
	}
	...
	public final int[] method4626(@OriginalArg(0) int arg0) {
		...
		if (this.aClass121_41.aBoolean221) {
			...
			for (@Pc(58) int local58 = 0; local58 < Static189.anInt4457; local58++) {
				...
				@Pc(142) int local142 = Class103.aByteArray53[(local113 * (local113 + 1) >> 1) + local98] & 0xFF;
