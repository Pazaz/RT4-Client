	...
	public static Class3_Sub2_Sub1[] method870() {
		...
		for (@Pc(15) int local15 = 0; local15 < Static165.anInt4038; local15++) {
			...
			if (Static239.aBoolean269) {
				local6[local15] = new Class3_Sub2_Sub1_Sub2(Static124.anInt3080, Static227.anInt5091, Static274.anIntArray440[local15], Static269.anIntArray252[local15], Static254.anIntArray488[local15], Static26.anIntArray66[local15], local37);
			} else {
