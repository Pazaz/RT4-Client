...
public final class Static123 {
	...
	public static void method2419() {
		...
		for (@Pc(3) int local3 = 0; local3 < SceneGraph.anInt917; local3++) {
			...
			@Pc(14) int local14;
			if (SceneGraph.anIntArray8 != null) {
				for (local14 = 0; local14 < SceneGraph.anIntArray8.length; local14++) {
					if (SceneGraph.anIntArray8[local14] != -1000000 && (local10.anInt4444 <= SceneGraph.anIntArray8[local14] || local10.anInt4447 <= SceneGraph.anIntArray8[local14]) && (local10.anInt4460 <= Static96.anIntArray234[local14] || local10.anInt4445 <= Static96.anIntArray234[local14]) && (local10.anInt4460 >= anIntArray292[local14] || local10.anInt4445 >= anIntArray292[local14]) && (local10.anInt4458 <= anIntArray454[local14] || local10.anInt4449 <= anIntArray454[local14]) && (local10.anInt4458 >= anIntArray427[local14] || local10.anInt4449 >= anIntArray427[local14])) {
						continue label194;
					}
				}
			}
			...
			if (local10.anInt4453 == 1) {
				...
				if (local14 >= 0 && local14 <= SceneGraph.visibility + SceneGraph.visibility) {
					local115 = local10.anInt4461 + SceneGraph.visibility - SceneGraph.anInt4539;
					if (local115 < 0) {
						local115 = 0;
					}
					local126 = local10.anInt4464 + SceneGraph.visibility - SceneGraph.anInt4539;
					...
					if (local137) {
						...
						local10.anInt4454 = (local10.anInt4458 - SceneGraph.anInt4903 << 8) / local158;
						local10.anInt4450 = (local10.anInt4449 - SceneGraph.anInt4903 << 8) / local158;
				...
				local14 = local10.anInt4461 + SceneGraph.visibility - SceneGraph.anInt4539;
				if (local14 >= 0 && local14 <= SceneGraph.visibility + SceneGraph.visibility) {
					...
					if (local137) {
						local158 = SceneGraph.anInt4903 - local10.anInt4458;
						if (local158 > 32) {
							local10.anInt4462 = 3;
						} else {
							if (local158 >= -32) {
				...
				if (local14 > 128) {
					...
					if (local115 <= local126) {
						...
						if (local430) {
							...
							local10.anInt4454 = (local10.anInt4458 - SceneGraph.anInt4903 << 8) / local14;
							local10.anInt4450 = (local10.anInt4449 - SceneGraph.anInt4903 << 8) / local14;
							SceneGraph.aClass120Array2[SceneGraph.anInt4870++] = local10;
						}
					}
				}
