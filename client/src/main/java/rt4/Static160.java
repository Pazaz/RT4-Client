...
public final class Static160 {
	...
	public static boolean method3049(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		@Pc(9) int local9 = arg3 * SceneGraph.anInt5205 + arg0 * Static81.anInt2222 >> 16;
		@Pc(19) int local19 = arg3 * Static81.anInt2222 - arg0 * SceneGraph.anInt5205 >> 16;
		@Pc(29) int local29 = arg1 * anInt2886 + local19 * SceneGraph.anInt3038 >> 16;
		@Pc(39) int local39 = arg1 * SceneGraph.anInt3038 - local19 * anInt2886 >> 16;
		if (local29 < 1) {
			local29 = 1;
		}
		@Pc(50) int local50 = (local9 << 9) / local29;
		@Pc(56) int local56 = (local39 << 9) / local29;
		@Pc(66) int local66 = arg2 * anInt2886 + local19 * SceneGraph.anInt3038 >> 16;
		@Pc(76) int local76 = arg2 * SceneGraph.anInt3038 - local19 * anInt2886 >> 16;
		if (local66 < 1) {
			local66 = 1;
		}
