...
public final class Static278 {
	...
	public static final Class100 aClass100_1101 = Static28.method790(" <col=ffff00>");

	@OriginalMember(owner = "client!wj", name = "e", descriptor = "Lclient!na;")
	public static Class100 aClass100_1102 = null;

	@OriginalMember(owner = "client!wj", name = "f", descriptor = "Lclient!na;")
	public static final Class100 aClass100_1103 = Static28.method790("ul");

	@OriginalMember(owner = "client!wj", name = "k", descriptor = "Lclient!na;")
	public static final Class100 aClass100_1104 = Static28.method790("Continuer");
	...
	public static void method4651(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) Class3_Sub15 arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7) {
		@Pc(32) int local32;
